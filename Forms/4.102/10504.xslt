...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10504&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10504.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.102.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td style="text-align:center; ">
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Сведения об объемах отпуска тепловой энергии по группам потребителей</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.102.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
						...
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr>
									<td width="60%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>юридические лица - поставщики тепловой энергии</xsl:text>
										</span>
										<br/>
									</td>
									<td width="20%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>до 25-го числа месяца, следующего за отчетным периодом</xsl:text>
										</span>
									</td>
									<td width="20%">
										<center>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Сведения об объемах отпуска тепловой энергии по группам потребителей</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
							...
							<tbody>
								<tr>
									<td style="text-align:right; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Код по ОКЕИ: тысяча гигакалорий – 234; гигакалория в час - 238</xsl:text>
										</span>
									</td>
								</tr>
							</tbody>
					...
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									<th rowspan="3" style="text-align:center; " width="40%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
									...
									<th colspan="3" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Поставщик тепловой энергии</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Базовый период</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Период регулирования</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Отчетный квартал</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
