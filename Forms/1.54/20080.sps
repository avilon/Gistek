...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20080_rpt.xsd" workingxmlfile="20080_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о распределении нефти и газового конденсата на внутренний рынок, минуя систему магистральных трубопроводов">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Отгрузка нефти и газового конденсата на внутренний рынок, минуя систему магистральных трубопроводов"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Грузоот"/>
													<newline/>
													<text fixtext="правитель"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Отгрузка за отчет-ный пе-риод, план, т"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Отгрузка за отчет-ный пе-риод, "/>
													<newline/>
													<text fixtext="факт, т"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Стои-мость от-гружен-ного про-дукта за отчетный период,"/>
													<newline/>
											...
											<tgridcell>
												<children>
													<text fixtext="Отгрузка с начала года, "/>
													<newline/>
													<text fixtext="факт, т"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Стои-мость отгруженного продукта с начала года,"/>
													<newline/>
													<text fixtext="тыс. руб."/>
													<newline/>
												</children>
