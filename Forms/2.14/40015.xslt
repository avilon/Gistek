...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;40015&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="40015.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:14pt; ">
					<xsl:text>Сведения о добыче и распределении газа</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о добыче газа</xsl:text>
				</span>
				<br/>
				<br/>
				<span>
					<xsl:text>Таблица 1. Добыча газа</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Добыча газа за отчетный период, тыс. куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Добыча газа с нача-ла года, тыс. куб. м</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Таблица 2. Параметры добываемого газа</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Плотность газа, кг/куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содержание азота, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содержание мета-на, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содержание эта-на, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содержание про-пана, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содержание дру-гих углеводород-ных газов, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Сведения о приходе, за исключением добычи, и распределении газа</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="2">
									<span>
										<xsl:text>Всего, тыс. куб. м</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th>
									<span>
										<xsl:text>за отчетный период</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Сведения об использовании попутного (нефтяного) газа</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="3">
									<span>
										<xsl:text>Показатели, тыс. куб. м</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 4. Сведения о производстве и распределении сухого отбензиненного газа, подготовленного на собственных ТУ и ГПЗ</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
				...
				<br/>
				<span>
					<xsl:text>Раздел 5. Сведения о распределении газа, принятого от других организаций</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
