...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;70114&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="70114.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Отчет о реализации мероприятий программы энергосбережения и повышения энергетической эффективности организаций с </xsl:text>
				</span>
				<br/>
				<span style="font-size:16pt; ">
					<xsl:text>участием государства и муниципального образования</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о реализации организацией мероприятий программы энергосбережения и повышения энергетической эффективности</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="4" style="width:1.14in; ">
									<span>
										<xsl:text>Наименование мероприятия, программы</xsl:text>
									</span>
								</th>
								<th rowspan="4" style="width:0.66in; ">
									<span>
							...
							<tr>
								<th style="width:1.14in; ">
									<span>
										<xsl:text>А</xsl:text>
									</span>
								</th>
								<th style="width:0.66in; ">
									<span>
										<xsl:text>Б</xsl:text>
									</span>
								</th>
										...
										<xsl:for-each select="strdata">
											<xsl:choose>
												<xsl:when test="@code != 30">
													<tr>
														<td rowspan="4" style="width:1.14in; ">
														...
														<td rowspan="4">
															<xsl:for-each select="econ">
																<xsl:for-each select="@econ_plan_natur">
																	<p>
																		<span>
																			<xsl:value-of select="string(.)"/>
																		</span>
														...
														<td rowspan="4">
															<xsl:for-each select="econ">
																<xsl:for-each select="@econ_fact_natur">
																	<p>
																		<span>
																			<xsl:value-of select="string(.)"/>
																		</span>
														...
														<td rowspan="4">
															<xsl:for-each select="econ">
																<xsl:for-each select="@econ_dx_natur">
																	<p>
																		<span>
																			<xsl:value-of select="string(.)"/>
																		</span>
														...
														<td rowspan="4">
															<xsl:for-each select="econ">
																<xsl:for-each select="@econ_plan_cost">
																	<p>
																		<span>
																			<xsl:value-of select="string(.)"/>
																		</span>
														...
														<td rowspan="4">
															<xsl:for-each select="econ">
																<xsl:for-each select="@econ_fact_cost">
																	<p>
																		<span>
																			<xsl:value-of select="string(.)"/>
																		</span>
														...
														<td rowspan="4">
															<xsl:for-each select="econ">
																<xsl:for-each select="@econ_dx_cost">
																	<p>
																		<span>
																			<xsl:value-of select="string(.)"/>
																		</span>
											...
											<xsl:choose>
												<xsl:when test="@code != 30">
													<tr>
														...
														<td>
															<span>
																<xsl:text>бюджет субъекта </xsl:text>
															</span>
															<br/>
															<span>
																<xsl:text>Российской </xsl:text>
															</span>
															<br/>
															<span>
											...
											<xsl:choose>
												<xsl:when test="@code != 30">
													<tr>
														...
														<td>
															<span>
																<xsl:text>местные</xsl:text>
															</span>
															<br/>
															<span>
																<xsl:text>бюджеты</xsl:text>
															</span>
														</td>
														<td>
															<xsl:for-each select="src_03">
											...
											<xsl:choose>
												<xsl:when test="@code != 30">
													<tr>
														...
														<td>
															<span>
																<xsl:text>внебюджетные</xsl:text>
															</span>
															<br/>
															<span>
																<xsl:text>средства</xsl:text>
															</span>
														</td>
														<td>
															<xsl:for-each select="src_04">
