...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;90003&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="90003.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.138.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.138.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
						...
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr>
									<td width="60%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>субъекты электроэнергетики, владеющие на праве собственности или на ином законном основании объектами электроэнергетики, установленная генерирующая мощность которых в совокупности равна или превышает 500 кВт (с детализацией по отдельным объектам электроэнергетики, установленная генерирующая мощность каждого из которых равна или превышает 500 кВт); территориальные сетевые организации (с детализацией по субъектам Российской Федерации);</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>организация по управлению единой национальной (общероссийской) электрической сетью (с детализацией по филиалам);</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>собственники или иные законные владельцы объектов электросетевого хозяйства, входящих в единую национальную (общероссийскую) электрическую сеть; системный оператор (с детализацией по филиалам);</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>иные субъекты оперативно-диспетчерского управления в электроэнергетике</xsl:text>
										</span>
										<br/>
									</td>
									<td width="20%">
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Сведения о работе по охране труда</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; " width="15%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>За аналогичный период предыдущего года</xsl:text>
										</span>
									</th>
									<th style="text-align:center; " width="15%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>С начала текущего года</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
