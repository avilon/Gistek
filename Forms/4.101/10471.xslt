...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10471&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10471.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.101.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Сведения о стоимости покупки (продажи) электроэнергии участником оптового рынка</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.101.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
						...
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr>
									<td width="50%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>организации, осуществляющие деятельность по организации торговли на оптовом рынке электроэнергии и мощности</xsl:text>
										</span>
									</td>
									<td width="25%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>до 30-го числа месяца, следующего за отчетным</xsl:text>
										</span>
									</td>
									<td width="25%">
										<center>
						...
						<table border="1" width="100%">
							...
							<tbody>
								<tr>
									<td width="40%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Наименование участника</xsl:text>
										</span>
									</td>
									<td/>
								</tr>
								<tr>
									<td width="40%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Идентификационный код участника</xsl:text>
										</span>
									</td>
									<td/>
								</tr>
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Рынок на сутки вперед</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 1.1.&#160;&#160; Продажа по договору комиссии</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>ГТП</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Объем электроэнергии, кВт•ч</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Цена, руб./кВт•ч</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Стоимость (без НДС), руб.</xsl:text>
										</span>
									</th>
								</tr>
							</thead>
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata1[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 1.2.&#160;&#160; Покупка по договору купли-продажи</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata2[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 2.&#160;&#160;&#160;&#160;&#160; Балансирующий рынок</xsl:text>
					</span>
					<br/>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 2.1.&#160;&#160; Продажа по договору комиссии</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata3[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 2.2.&#160;&#160; Покупка по договору купли-продажи</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata4[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 3.&#160;&#160;&#160;&#160; Покупка/продажа электроэнергии по четырехсторонним договорам</xsl:text>
					</span>
					<br/>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 3.1.&#160;&#160; Продажа по четырехсторонним договорам</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Неценовая зона</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 3.2.&#160;&#160; Покупка по четырехсторонним договорам</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata6[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 4.&#160;&#160;&#160;&#160; Покупка/продажа мощности по четырехсторонним договорам</xsl:text>
					</span>
					<br/>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 4.1.&#160;&#160; Продажа по четырехсторонним договорам</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Объем мощности, МВт</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata7[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 4.2.&#160;&#160; Покупка по четырехсторонним договорам</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata8[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 5.&#160;&#160;&#160;&#160; Покупка/продажа электроэнергии по двусторонним договорам</xsl:text>
					</span>
					<br/>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 5.1.&#160;&#160; Продажа по двусторонним договорам</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata9[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Таблица 5.2.&#160;&#160; Покупка по двусторонним договорам</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata10[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td style="text-align:center; ">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<span style="font-family:Times New Roman; ">
						<xsl:text>Раздел 6. Дата предоставления информации для включения в государственную информационную систему топливно-энергетического комплекса</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
					...
					<br/>
					<span style="font-family:Times New Roman; ">
						<xsl:text>Раздел 7. Контактная информация</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
