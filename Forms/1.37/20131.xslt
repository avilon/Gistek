...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;20131&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="20131.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения об объемах добычи и льготах при извлечении и распределении трудноизвлекаемой нефти</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о добыче нефти, облагаемой по полной ставке НДПИ</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Номер ли-цензии</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Срок дей-ствия лицен-зии</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Залежь</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Вид уг-леводо-родного сырья</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Код стро-ки</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Степень вырабо-танности место-рожде-ния, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Сведения о добыче нефти, облагаемой по льготной ставке НДПИ</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Применяемая ставка НДПИ, руб./т (руб./ тыс. куб. м)</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Величина запасов</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Глубина залегания</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Качество запасов</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Регион добычи (вкл. Новые месторождения)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Свойства нефти</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Степень выработанности</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Степень сложности добычи нефти</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Владение объектами ЕСГ</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Участки недр, принадлежащие к региональной системе газоснабжения</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Нормативные потери</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Категория льготы по ставке НДПИ: Добыча ПНГ</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Сведения о реализации нефти на экспорт, облагаемой по льготной экспортной пошлине</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Нмер лицензии</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
							...
							<tr>
								...
								<th>
									<span>
										<xsl:text>Страна-импор-тер</xsl:text>
									</span>
								</th>
								<th>
									<span>
