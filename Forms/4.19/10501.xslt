...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10501&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10501.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.19.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Предложения о консервации генерирующего оборудования электростанций за______года</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.19.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Предложения по консервации генерирующего оборудования на действующих электростанциях (на прогнозный период 15 лет)</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Номер энергоагрегата (станционный номер)</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Вид основного топлива энергоагрегата</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Вид резервного топлива энергоагрегата</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Установленная электрическая мощность консервируемого энергоагрегата, МВт</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Установленная тепловая мощность консервируемого энергоагрегата, Гкал/ч</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
									...
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Ожидаемый месяц и год консервации</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Ожидаемый месяц и год расконсервации</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
