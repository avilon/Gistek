...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;20171&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="20171.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о запасах нефти по месторождениям</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Общие сведения о наличии углеводородных месторождений в Российской Федерации</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="2">
									<span>
										<xsl:text>Ведомственная принадлежность</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Номер лицен-зии</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Тип ме-сторождения по составу углеводородных соединений</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Пласт</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Кол-лектор</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование углеводородного сырья</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Глубина залега-ния, м</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Минимальная</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Максимальная</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="4">
									<span>
										<xsl:text>Начальные запасы, т (тыс. куб. м)</xsl:text>
									</span>
								</th>
								<th colspan="4">
									<span>
										<xsl:text>Текущие запасы, т (тыс. куб. м)</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th colspan="2">
									<span>
										<xsl:text>геологические</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>извлекаемые</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Сведения о ресурсах углеводородного сырья в соответствии с Российской системой классификации запасов</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="4">
									<span>
										<xsl:text>Ресурсы по степени изученности, т (тыс. куб. м)</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 4. Сведения об изменениях за отчетный период запасов нефти и попутных полезных ископаемых в разрезе причин</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="7">
									<span>
										<xsl:text>Изменения запасов категорий А+В+С1, т (тыс. куб. м)</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>В результате добычи</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>В результате разведки</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>В результате переоценки</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>В результате передачи с баланса на баланс</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th>
									<span>
										<xsl:text>Геологические запасы</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>В т.ч. извлекаемые</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 5. Прочая информация, необходимая для расчета коэффициентов, характеризующих степень выработанности разведанных запасов и степень разведанности начальных суммарных ресурсов</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Наимено-вание уг-леводо-родного сырья</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									...
									<br/>
									<span>
										<xsl:text>за отчетный период, т (тыс. куб. м)</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									...
									<br/>
									<span>
										<xsl:text>с начала</xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>разработки, т (тыс. куб. м)</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>Обводненность залежи, %</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata_05">
											<tr>
												<td>
													<xsl:for-each select="@column1">
														<span>
