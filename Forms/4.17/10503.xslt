...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10503&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10503.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.17.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
								...
								<tr>
									<td style="text-align:center; ">
										<center style="text-align:center; ">
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Предложения о вводе в эксплуатацию генерирующего оборудования электростанций за_____год</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.17.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
						...
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr>
									<td width="50%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>субъекты электроэнергетики, владеющие на праве собственности или на ином законном основании объектами электроэнергетики, установленная генерирующая мощность которых в совокупности равна или превышает 5 МВт (с детализацией по отдельным объектам электроэнергетики)</xsl:text>
										</span>
									</td>
									<td width="25%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
									...
									<td>
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strsubject">
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Предложения о вводе в эксплуатацию генерирующего оборудования электростанций</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1">
								...
								<tr>
									<th rowspan="2">
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Наименование энергообъекта</xsl:text>
										</span>
									</th>
									<th rowspan="2">
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Энергоагрегат</xsl:text>
										</span>
									</th>
									<th rowspan="2">
										<span style="font-family:Times New Roman; font-size:9pt; ">
									...
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Тип энергоагрегата</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Место расположения площадки</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Вид основного топлива</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Вид резервного топлива</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Направление инвестиций</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Ожидаемые месяц и год ввода в эксплуатацию</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Текущая стадия проработки предложения</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Присутствие инвестпроекта в перечне объектов поставки мощности (да, нет)</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Предполагаемая плата за технологическое присоединение, тыс. руб.</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Планируется подключение к ЕЭС России (да, нет)</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Риск</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Срок переноса проекта в случае риска</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata[@col10 ne &quot;&quot; and @col11 ne &quot;&quot;]">
											<tr>
												<td>
													<xsl:for-each select="@col2">
					...
					<span style="font-size:12pt; ">
						<xsl:text>Раздел 2. Технико-экономические показатели оборудования, входящего в состав энергоагрегатов</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th rowspan="2">
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Оборудование в составе энергоагрегата</xsl:text>
										</span>
									</th>
									<th rowspan="2">
										<span style="font-family:Times New Roman; font-size:9pt; ">
									...
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Производитель оборудования</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Мощность электрическая, МВт</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Мощность тепловая, Гкал/ч</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>КПД (суммарный для когенерационных установок), %</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Номинальный срок службы, лет</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Стоимость оборудования, млн руб.</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Планируемая стоимость ежегодного обслуживания оборудования, млн руб.</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Удельные капиталовложения,</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>тыс. руб./кВт</xsl:text>
										</span>
										<br/>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Удельный расход топлива на выработку ЭЭ, г у.т./кВт∙ч</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Удельный расход топлива на выработку ТЭ, кг у.т./Гкал</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
