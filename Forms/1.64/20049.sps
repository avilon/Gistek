...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20049_rpt.xsd" workingxmlfile="20049_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сводный исполнительный баланс нефти и газового конденсата по системе трубопроводного транспорта">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сводный исполнительный баланс нефти и газового конденсата по системе трубопроводного транспорта"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Нефть и газовый конденсат сторонних организаций, т"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
												<children>
													<text fixtext="Собственные нефть и газовый конденсат, т"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
										</children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Факт за квартал"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Факт с начала года"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
