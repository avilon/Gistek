...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="70129.xsd" workingxmlfile="70129.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<newline/>
					<text fixtext="Сведения о целевых и прочих показателях программы энергосбережения и повышения энергетической эффективности организаций, осуществляющих регулируемые виды деятельности">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о целевых и прочих показателях программы энергосбережения и повышения энергетической эффективности организаций, осуществляющих регулируемые виды деятельности"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Наименование показателя программы"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
											...
											<template subtype="element" match="document">
												<children>
													<template subtype="element" match="flat">
														<children>
															<template subtype="element" match="goal">
																<children>
																	<tgridrow>
																		<children>
																			<tgridcell>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="avg">
																						<children>
																							<content subtype="regular">
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="basic_year">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_dowto_4">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_dowto_3">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_dowto_2">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_dowto_1">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_curr">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_to_1">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_to_2">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_to_3">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_to_4">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
