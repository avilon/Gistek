...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;70130&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="70130.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Перечень мероприятий, основной целью которых является энергосбережение и (или) повышение энергетической эффективности организаций, осуществляющих регулируемые виды деятельности</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Перечень мероприятий, основной целью которых является энергосбережение и (или) повышение энергетической эффективности организаций, осуществляющих регулируемые виды деятельности</xsl:text>
				</span>
				<br/>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr style="height:0.22in; ">
								<th rowspan="3">
									<span>
										<xsl:text>Наименование мероприятия программы</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="3">
								...
								<th colspan="11">
									<span>
										<xsl:text>Объемы выполнения, план, с разбивкой по годам действия программы												</xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>						</xsl:text>
								...
								<th colspan="29">
									<span>
										<xsl:text>Экономия от реализации мероприятий, план, с разбивкой по годам действия программы																</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="3" rowspan="2">
									<span>
										<xsl:text>Показатели экономической эффективности		</xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>		</xsl:text>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Срок амортизации, лет</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="9" rowspan="2">
									<span>
										<xsl:text>Затраты, план, млн. руб., без НДС, с разбивкой по годам действия программы				</xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>				</xsl:text>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Статья затрат</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="3">
									<span>
										<xsl:text>Источник финансирования</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>экономия - всего по годам в натуральном выражении</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="3">
							...
							<tr>
								<th>
									<span>
										<xsl:text>экономия&#160; в натуральном выражении</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>экономия, т у. т.</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>экономия в стоимостном выражении, млн. руб.</xsl:text>
									</span>
									<br/>
								</th>
								<th>
								...
								<th>
									<span>
										<xsl:text>дисконтированный срок окупаемости, лет</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>ВНД, %</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>ЧДД, млн. руб.</xsl:text>
									</span>
									<br/>
									<br/>
								</th>
									...
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata">
											<tr>
												...
												<td>
													<xsl:for-each select="@vol_year_downto_4">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_year_downto_3">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_year_downto_2">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_year_downto_1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_year_to_1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_year_to_2">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_year_to_3">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_year_to_4">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_tot">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_downto_4">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_downto_4">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan_downto_4">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_downto_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_downto_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan_to_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_downto_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_downto_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan_downto_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_downto_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_downto_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan_downto_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_to_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_to_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan_to_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_to_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_to_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan_to_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_to_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_to_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_plan_to_4">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_tut_plan_to_4">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_plan_to_4">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td>
													<xsl:for-each select="@payback_period">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_downto_4">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_downto_3">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_downto_2">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_downto_1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_to_1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_to_2">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_to_3">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_to_4">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@pay_section">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
