...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;70157&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="70157.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Информация о внедрении системы энергетического менеджмента</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел  1 Общие сведения об организациях, о внедрении и сертификации системы энергетического менеджмента</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование организации, филиала/дочернего зависимого общества</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="2">
								...
								<th colspan="4">
									<span>
										<xsl:text>План (программа) разработки, внедрения и сертификации системы энергетического менеджмента в организации (филиале/дочернем зависимом обществе), сроки деятельности по разработке и внедрению/сертификации системы энергетического менеджмента			</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="3">
									<span>
										<xsl:text>Сведения о сертификации		</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								...
								<th>
									<span>
										<xsl:text>реквизиты инициирующего документа</xsl:text>
									</span>
									<br/>
								</th>
								<th>
								...
								<th>
									<span>
										<xsl:text>сертификация пройдена в соответствии с требованиями международного стандарта ISО 50001 (да/нет)</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>наименование органов по сертификации, сертифицировавших систему энергетического менеджмента на соответствие требованиям международного стандарта ISО 50001</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>сведения о внедрении других систем менеджмента (в соответствии с требованиями стандартов ISO 9001, 14001, 22301, 55001 и т.д)</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел  2 Сведения о действующих в организациях документах, определяющих деятельность в области энергетического менеджмента (энергосбережения и повышения энергетической эффективности)</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="2">
									<span>
										<xsl:text>Сведения о действующих в организации документах, определяющих деятельность в области энергосбережения и повышения энергетической эффективности (энергетического менеджмента)	</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
							<tr>
								...
								<th>
									<span>
										<xsl:text>дата принятия</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел  3 Сведения о динамике основных показателей (индикаторов) в области энергосбережения и повышения энергетической эффективности</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr style="height:0.20in; ">
								...
								<th rowspan="2">
									<span>
										<xsl:text>Наименование показателя (индикатора)</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="2">
								...
								<th colspan="4">
									<span>
										<xsl:text>Значения показателя			</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
									...
									<xsl:for-each select="flat">
										<xsl:for-each select="dynamic">
											<tr>
												...
												<td>
													<xsl:for-each select="@pokaz_name">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@val_year_downto_3">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@val_year_downto_2">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@val_year_downto_1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
				...
				<br/>
				<span>
					<xsl:text>Раздел  4 Ответственные за систему энергетического менеджмента, систему менеджмента качества и систему экологического менеджмента</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Зона ответственности</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="4">
									<span>
										<xsl:text>Сведения об ответственных лицах			</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
									...
									<xsl:for-each select="flat">
										<xsl:for-each select="managers">
											<tr>
												...
												<td>
													<span>
														<xsl:text>Энергетика</xsl:text>
													</span>
												</td>
												<td>
													<xsl:for-each select="mngr_energo">
											...
											<tr>
												<td>
													<span>
														<xsl:text>Качество</xsl:text>
													</span>
												</td>
												<td>
													<xsl:for-each select="mngr_quality">
														<xsl:for-each select="@fio">
															<span>
																<xsl:value-of select="string(.)"/>
															</span>
											...
											<tr>
												<td>
													<span>
														<xsl:text>Экология</xsl:text>
													</span>
												</td>
												<td>
													<xsl:for-each select="mngr_ecology">
														<xsl:for-each select="@fio">
															<span>
																<xsl:value-of select="string(.)"/>
															</span>
