...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="10188.xsd" workingxmlfile="10188.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell rotation="vertical-left">
												<children>
													<text fixtext="Выработка электрической энергии, тыс. кВтч"/>
												</children>
											</tgridcell>
											<tgridcell rotation="vertical-left">
												<children>
													<text fixtext="Отпуск тепловой энергии, Гкал"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Поставка, "/>
													<newline/>
													<text fixtext="т, тыс. м3"/>
													<newline/>
												</children>
											</tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Норматив запаса на начало периода, т"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell joinleft="1"/>
											...
											<tgridcell>
												<children>
													<text fixtext="Расчетный запас на начало периода, т"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell joinleft="1"/>
											...
											<tgridcell>
												<children>
													<text fixtext="Норматив запаса на конец периода, т"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell joinleft="1"/>
											...
											<tgridcell>
												<children>
													<text fixtext="Расчетный запас на конец периода, т"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell joinleft="1"/>
									...
									<tgridrow>
										<children>
											...
											<tgridcell rotation="vertical-left">
												<children>
													<text fixtext="дизельное топливо"/>
												</children>
											</tgridcell>
											<tgridcell rotation="vertical-left">
												<children>
													<text fixtext="газ естественный"/>
												</children>
											</tgridcell>
											<tgridcell rotation="vertical-left">
												<children>
																...
																<children>
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="column22">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="column23">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="column24">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="column25">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="column26">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="column27">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="column28">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
