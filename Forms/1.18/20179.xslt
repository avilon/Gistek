...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;20179&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="20179.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о лицензионных обязательствах пользователей недр, а также сведения о показателях разработки участков недр, утвержденных проектным документом</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о лицензиях организаций-пользователей недр</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Компа-ния</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Предприятие недропользователь</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Код строи</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата подачи лицензии на регистрацию</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата присвоения государственного регистрационного номера</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Государственный регистрационный номер лицензии</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Целевое назначение пользования недрами</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Орган, выдавший разрешение на пользование недрами</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Название участка недр. Вид объекта. Местоположение</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Статус участка</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Уполномоченный орган управления фондом недр</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата окончания срока действия лицензии</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Сведения о показателях разработки участков недр</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Предпри-ятие-недро-пользова-тель</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Государ-ственный реги-страци-онный номер лицензии</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Дата начала работ на участке недр</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Порядок ввода эксплуа-тацион-ных объ-ектов в разработ-ку</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Планиру-емая дата выхода на проект-ную мощность</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Планиру-емая дата оконча-ния работ на участ-ке недр</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Добыча нефти, т</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Степень извлечения, %</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Добыча жидкости всего, т</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Закачка вытесня-ющих агентов в пласт, т</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Объем сброшенных в недра отходов и про-мышленных сточных вод, т</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Технические потери при добыче, т</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Норматив на отчет-ный пе-риод</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Порядок и условия первич-ной пере-работки добытых углеводо-родов</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th>
									<span>
										<xsl:text>Факт за отчетный период</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>План на следую-щий от-четный период</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Нефть</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Газ нефтяной попутный</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<xsl:variable name="altova:ColumnData">
							<xsl:for-each select="$XML">
								<altova:Element altova:sDesignElemId="3" altova:sNodeId="{generate-id(.)}" altova:sDocumentUri="{document-uri(root(.))}">
									<xsl:for-each select="document">
										<altova:Element altova:sDesignElemId="4" altova:sNodeId="{generate-id(.)}" altova:sDocumentUri="{document-uri(root(.))}">
											<xsl:for-each select="flat">
												<altova:Element altova:sDesignElemId="5" altova:sNodeId="{generate-id(.)}" altova:sDocumentUri="{document-uri(root(.))}">
													<xsl:for-each select="strServiceInf">
														<altova:Element altova:sDesignElemId="6" altova:sNodeId="{generate-id(.)}" altova:sDocumentUri="{document-uri(root(.))}"/>
													</xsl:for-each>
												</altova:Element>
											</xsl:for-each>
										</altova:Element>
						...
						<tbody>
							<tr>
								<th>
									<span>
										<xsl:text>Наименование отчитывающейся </xsl:text>
									</span>
									<br/>
									<span>
								...
								<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 3 ]"/>
								<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
									...
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:nodeCurrPseudo/altova:Element[ @altova:sDesignElemId = 4 ]"/>
									<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
										<xsl:variable name="altova:posCurrPseudo" select="position()"/>
										<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
										<xsl:variable name="altova:nodesNextPseudo" select="$altova:nodeCurrPseudo/altova:Element[ @altova:sDesignElemId = 5 ]"/>
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nodesNextPseudo" select="$altova:nodeCurrPseudo/altova:Element[ @altova:sDesignElemId = 6 ]"/>
											<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
												<xsl:variable name="altova:posCurrPseudo" select="position()"/>
												<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
												<td>
							...
							<tr>
								<th>
									...
									<br/>
									<span>
										<xsl:text>( Основной государственный </xsl:text>
									</span>
									<br/>
									<span>
							...
							<tr>
								<th>
									...
									<br/>
									<span>
										<xsl:text> (Идентификационный номер </xsl:text>
									</span>
									<br/>
									<span>
							...
							<tr>
								<th>
									...
									<br/>
									<span>
										<xsl:text> (Код причины постановки</xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text> на учет)</xsl:text>
									</span>
								</th>
								<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 3 ]"/>
								<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
							...
							<tr>
								<th>
									...
									<br/>
									<span>
										<xsl:text>(Общероссийский классификатор </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>предприятий и организаций)</xsl:text>
									</span>
								</th>
								<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 3 ]"/>
								<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
							...
							<tr>
								<th>
									<span>
										<xsl:text>ОКОГУ</xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text> (Код министерства (ведомства), </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>органа управления)</xsl:text>
									</span>
								</th>
								<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 3 ]"/>
								<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
							...
							<tr>
								<th>
									<span>
										<xsl:text>ОКОПФ </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>(Код организационно-правовой </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>формы)</xsl:text>
									</span>
								</th>
								<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 3 ]"/>
								<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
							...
							<tr>
								<th>
									<span>
										<xsl:text>ОКФС </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>(Код формы собственности)</xsl:text>
									</span>
								</th>
								<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 3 ]"/>
								<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri))">
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th>
									<span>
										<xsl:text>ФИО руководителя организации</xsl:text>
									</span>
								</th>
								<th>
									<span>
