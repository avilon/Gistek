...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;70120&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="70120.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о фактических значениях целевых показателей и индикаторов государственных программ субъектов Российской Федерации</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел  1 Сведения о фактических значениях целевых показателей государственных программ субъектов Российской Федерации, установленных из перечня целевых показателей в области энергосбережения и повышения энергетической эффективности согласно постановлению Правительства Российской Федерации от 31 декабря 2009 г. N 1225					</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Значение целевого показателя за отчетный год, план</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>Значение целевого показателя за отчетный год, факт</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>Значение целевого показателя за отчетный год, отклонение</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел  2 Сведения о фактических значениях иных целевых показателях в области энергосбережения и повышения энергетической эффективности, определенных органом исполнительной власти субъекта Российской Федерации при разработке региональной программы в области энергосбережения и повышения энергетической эффективности					</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
				...
				<br/>
				<span>
					<xsl:text>Раздел  3 Сведения о фактических значениях индикаторов, используемых для расчета целевых показателей государственных программ субъектов Российской Федерации, установленных из перечня целевых показателей в области энергосбережения и повышения энергетической эффективности согласно постановлению Правительства Российской Федерации от 31 декабря 2009 г. N 1225					</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Значение индикатора, используемого для расчета целевого показателя, за отчетный год</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел  4 Сведения о фактических значениях индикаторов, используемых для расчета иных целевых показателей в области энергосбережения и повышения энергетической эффективности, определенных органом исполнительной власти субъекта Российской Федерации при разработке региональной программы в области энергосбережения и повышения энергетической эффективности					</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
