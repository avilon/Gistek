...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30010&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30010.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				...
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о численности работников и начисленной заработной плате </xsl:text>
				</span>
				<br/>
				<span style="font-size:16pt; ">
				...
				<xsl:variable name="altova:table">
					<table border="1" width="100%">
						...
						<tbody>
							<tr>
								<td rowspan="3" style="text-align:center; width:1.92in; ">
								...
								<td colspan="3" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>Средняя численность, чел.</xsl:text>
									</span>
								</td>
								<td colspan="3" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>Фонд начисленной заработной платы,&#160; тыс. руб.</xsl:text>
									</span>
								</td>
								<td colspan="3" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>Выплаты социального характера, тыс. руб.</xsl:text>
									</span>
								</td>
							</tr>
							<tr>
								...
								<td style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>За предыдущий отчетный месяц</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>За месяц, соответствующий отчетному прошлого года</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span style="font-weight:bold; ">
							...
							<tr>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=1]">
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=2]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=3]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td style="width:1.92in; ">
									<span>
										<xsl:text>Из строки 1 по основному виду деятельности</xsl:text>
									</span>
								</td>
								<td>
									<span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=11]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=21]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=31]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td style="width:1.92in; ">
									<span>
										<xsl:text> административно–&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; управленческий аппарат,&#160;&#160; </xsl:text>
									</span>
								</td>
								<td>
									<span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=121]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=221]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=321]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=122]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=222]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=322]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td style="width:1.92in; ">
									<span>
										<xsl:text>рабочие по добыче.</xsl:text>
									</span>
								</td>
								<td>
									<span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=123]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=223]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=323]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
