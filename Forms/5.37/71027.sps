...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="71027.xsd" workingxmlfile="71027.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
			...
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<paragraph paragraphtag="pre">
						...
						<children>
							<text fixtext="Приложение № 5.37.1">
										...
										<children>
											<tgridcell>
												<children>
													<paragraph paragraphtag="center">
														<children>
															<text fixtext="Показатели энергетической эффективности объектов, создание или модернизация которых планируется инвестиционными программами субъектов естественных монополий, оказывающих услуги в аэропортах, за 20__ г.">
