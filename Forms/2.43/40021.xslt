...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;40021&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="40021.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения об использовании мощностей газоперерабатывающих заводов и компрессорных станций России</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения об использовании мощностей объектов переработки и компримирования газа</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Вид перера-батываемого/</xsl:text>
									</span>
									<br/>
									<span>
								...
								<th rowspan="2">
									...
									<br/>
									<span>
										<xsl:text>установки/</xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>агрегата</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="2">
								...
								<th>
									<span>
										<xsl:text>Год ввода в действие</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Процент использования мощности в отчетном периоде, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Установленная мощность по сырью на конец отчет-ного года, тыс. куб. м (т)</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Сведения об использовании мощностей по производству продукции на газоперерабатывающих заводах и компрессорных станциях России</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									...
									<br/>
									<span>
										<xsl:text>производимой </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>продукции</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="2">
								...
								<th>
									<span>
										<xsl:text>Установленная мощность по продукту на конец отчетного года, тыс. куб. м (т)</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Информация о местоположении компрессорных станций</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="3">
									<span>
										<xsl:text>Наименование станции</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
