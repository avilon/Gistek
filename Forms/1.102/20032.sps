...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20032_rpt.xsd" workingxmlfile="20032_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о товарных остатках автомобильного бензина и дизельного топлива ">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<text fixtext="на предприятиях нефтепродуктообеспечения">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о товарных остатках автомобильного бензина и дизельного топлива на предприятиях нефтепродуктообеспечения "/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Наименование нефтебазы"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Товарный остаток, т"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Свободная емкость, т"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
