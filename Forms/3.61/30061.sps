...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="30061.xsd" workingxmlfile="30061.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о фактических и прейскурантных ценах на угольную продукцию">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о фактических и прейскурантных ценах на угольную продукцию"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Средняя фактическая цена на угольную  продукцию за отчетный месяц "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Средняя фактическая цена на угольную продукцию, поставленную энергокомпаниям за отчетный месяц "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Прейскурант на угольную  продукцию на предстоящий месяц "/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
