...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20054_rpt.xsd" workingxmlfile="20054_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о бурении скважин">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о бурении скважин"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Факт за аналогичный месяц прошлого года, "/>
													<newline/>
													<text fixtext="тыс. м"/>
													<newline/>
												</children>
