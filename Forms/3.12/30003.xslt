...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30003&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30003_rpt.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:14pt; ">
					<xsl:text>Сведения о качестве отгруженного угля</xsl:text>
				</span>
				<br/>
				<span style="font-size:14pt; ">
				...
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о качестве отгруженных углей </xsl:text>
				</span>
				<br/>
				<br/>
				<span>
					<xsl:text>СВЕДЕНИЯ О КАЧЕСТВЕ ОТГРУЖЕННЫХ УГЛЕЙ за _____ кв.&#160; 20__ г.</xsl:text>
				</span>
				<br/>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="4">
									<span>
										<xsl:text>Предприятия, марки, продуктомарки</xsl:text>
									</span>
								</th>
								<th rowspan="4">
									<span>
										<xsl:text>Код строки или продуктомарки</xsl:text>
									</span>
								</th>
								<th rowspan="4">
									<span>
									...
									<br/>
									<span>
										<xsl:text> отчетности</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="4">
									<span>
										<xsl:text>Всего отгружено потребителям</xsl:text>
									</span>
								</th>
								<th colspan="9">
									<span>
										<xsl:text>Из графы 1 – в том числе отгружено на:</xsl:text>
									</span>
								</th>
								<th colspan="4">
									<span>
										<xsl:text>Кроме того отгружено на обогатительные фабрики, центральные сортировки</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Израсходовано на собственные нужды</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th rowspan="3">
									<span>
										<xsl:text>тонн</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
										<xsl:text>средняя норма зольности, %</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>фактическое содержание, %</xsl:text>
									</span>
								</th>
								<th colspan="5">
									<span>
										<xsl:text>коксование</xsl:text>
									</span>
								</th>
								<th colspan="4">
									<span>
										<xsl:text>электростанции</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
								...
								<th rowspan="3">
									<span>
										<xsl:text>фактическая зольность, %</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>золы</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>влаги</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
