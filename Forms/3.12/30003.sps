...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="30003_rpt.xsd" workingxmlfile="30003_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о качестве отгруженного угля">
					...
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о качестве отгруженных углей "/>
					<newline/>
					<newline/>
					<text fixtext="СВЕДЕНИЯ О КАЧЕСТВЕ ОТГРУЖЕННЫХ УГЛЕЙ за _____ кв.  20__ г."/>
					<newline/>
					<newline/>
					<tgrid>
						<properties border="1"/>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Предприятия, марки, продуктомарки"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Код строки или продуктомарки"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Период"/>
													<newline/>
													<text fixtext=" отчетности"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Всего отгружено потребителям"/>
												</children>
											</tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Из графы 1 – в том числе отгружено на:"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell joinleft="1"/>
											...
											<tgridcell>
												<children>
													<text fixtext="Кроме того отгружено на обогатительные фабрики, центральные сортировки"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell joinleft="1"/>
											...
											<tgridcell>
												<children>
													<text fixtext="Израсходовано на собственные нужды"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
										</children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="средняя норма зольности, %"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="фактическое содержание, %"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
												<children>
													<text fixtext="коксование"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell joinleft="1"/>
											...
											<tgridcell>
												<children>
													<text fixtext="фактическая зольность, %"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
