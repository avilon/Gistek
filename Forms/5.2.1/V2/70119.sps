...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="C:\WorkStudio\Projects\Endevel\Gistek\Infostream\5.2.1\70119_v3.xsd" workingxmlfile="C:\WorkStudio\Projects\Endevel\Gistek\Infostream\5.2.1\70119_v3.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о фактических значениях целевых показателей и индикаторов муниципальных программ">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о фактических значениях целевых показателей и индикаторов муниципальных программ"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Муниципальное образование"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Значение целевого показателя		"/>
													<newline/>
												</children>
											</tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Индикаторы, используемые для расчета целевого показателя		"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
																	...
																	<tgridrow>
																		<children>
																			<tgridcell>
																				...
																				<children>
																					<template subtype="userdefined" match="if (@id  = 1) then @mo else &quot;&quot;">
																						<children>
																			...
																			<tgridcell>
																				<styles border-bottom-style="none" border-top-style="none"/>
																				<children>
																					<template subtype="userdefined" match="if (@id  = 1) then @oktmo else &quot;&quot;">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<tgrid hidecols="when-empty" hiderows="when-empty">
																						<properties align="center" border="2"/>
																						<styles border-bottom-style="none" border-collapse="collapse" border-style="none" margin-bottom="0" margin-left="0" margin-right="0" margin-top="0" padding-left="0" padding-right="0" padding-top="0" text-align="center" vertical-align="middle"/>
																						<children>
																							<tgridbody-cols>
																								<children>
																									<tgridcol>
																										<styles border-style="none" width="160px"/>
																									</tgridcol>
																								</children>
																							</tgridbody-cols>
																							<tgridbody-rows>
																								<styles border-style="none" empty-cells="hide" vertical-align="middle"/>
																								<children>
																									<template subtype="element" match="child">
																										<children>
																											<tgridrow>
																												<styles border-style="none" empty-cells="hide" height="1.50in"/>
																												<children>
																													<tgridcell>
																														<styles border-bottom-style="solid" border-style="solid" top="inherit" vertical-align="middle"/>
																														<children>
																															<template subtype="attribute" match="nameInd">
																																<children>
																																	<content subtype="regular">
