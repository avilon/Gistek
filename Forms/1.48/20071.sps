...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20071_rpt.xsd" workingxmlfile="20071_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Оперативная сводка о поставке нефти и газового конденсата на внутренний рынок">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о транспортировке и распределении нефти и газового конденсата на внутреннем рынке"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Направление исполь-зования продукта"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Вид транс-портировки"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Объем сдачи за сутки,"/>
													<newline/>
													<text fixtext="т"/>
													<newline/>
												</children>
