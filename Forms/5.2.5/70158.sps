...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="70158.xsd" workingxmlfile="70158.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Расчет показателей в области энергосбережения и повышения энергетической эффективности, включаемых в отраслевые государственные программы субъектов Российской Федерации (подпрограммы) в отраслях экономики, включая здравоохранение, образование, ЖКХ, отрасли промышленности, сельское хозяйство и транспорт">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Индикаторы для расчета целевых показателей в области энергосбережения и повышения энергетической эффективности, включаемых в отраслевые региональные программы (подпрограммы) в здравоохранении, образовании, жилищно-коммунальном хозяйстве, промышленности, сельском хозяйстве, транспорте"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Наименование индикатора"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
					...
					<newline/>
					<text fixtext="Раздел 2. Целевые показатели в области энергосбережения и повышения энергетической эффективности, включаемые в отраслевые региональные программы (подпрограммы) в здравоохранении, образовании, жилищно-коммунальном хозяйстве, промышленности, сельском хозяйстве, транспорте"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Расчетная формула"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
																...
																<children>
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="formula">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="val">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
