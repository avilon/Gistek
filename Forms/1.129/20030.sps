...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20030_rpt.xsd" workingxmlfile="20030_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о реализации сжиженных углеводородных газов">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о реализации сжиженных углеводородных газов "/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="СУГ, всего, т"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="в том числе по фракциям"/>
												</children>
											</tgridcell>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Пропановая фракция, тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Пропан-пропиленовая фракция, тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Бутан нормальный, тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Изобутановая фракция, тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Бутан-бутиленовая фракция, тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Пропан-бутановая фракция, тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Пентан, тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Прочие фракции СУГ, тонн"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
