...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;40025&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="40025.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о работе завода по производству сжиженного природного газа</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Информация о поступлении газа на завод по производству СПГ</xsl:text>
				</span>
				<br/>
				<span>
					<xsl:text>Таблица 1.1. Поступление газа</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="4">
									<span>
										<xsl:text>Вид сырья</xsl:text>
									</span>
								</th>
								<th rowspan="4">
									<span>
										<xsl:text>Поставщик </xsl:text>
									</span>
								</th>
								<th rowspan="4">
									<span>
										<xsl:text>Импорт (Да / Нет)</xsl:text>
									</span>
								</th>
								<th rowspan="4">
									<span>
								...
								<th colspan="3">
									<span>
										<xsl:text>Поставка, тыс. куб. м</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>План за месяц</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
				...
				<br/>
				<span>
					<xsl:text>Таблица 1.2. Использование газа на заводе</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Направление использования сырья на заводе</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
								...
								<th colspan="2">
									<span>
										<xsl:text>Использование сырья, тыс. куб. м</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Информация о производстве и распределении сжиженного природного газа</xsl:text>
				</span>
				<br/>
				<span>
					<xsl:text>Таблица 2.1. Информация о производстве и распределении сжиженного природного газа</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							...
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>План за от-четный ме-сяц</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
				...
				<br/>
				<span>
					<xsl:text>Таблица 2.2 Информация о химическом составе производимого сжиженного природного газа</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Содер-жание азота, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содер-жание метана, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содер-жание этана, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содержание пропана, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Содержание других углеводородных газов, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Исходная плотность газов, кг/куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Плотность производимых сжиженных природных газов, кг/л</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Коэффициент расширения газа, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Теплотворная способность, МДж/кг</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Таблица 3.1. Информация о производительности и капитальных затратах</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Производственная мощность, т/год</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Количество тех-нологических линий, шт.</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Капитальные затраты за месяц, тыс. руб.</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Таблица 3.2. Информация о местоположении завода</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="3">
									<span>
										<xsl:text>Северной широты</xsl:text>
									</span>
								</th>
								<th colspan="3">
									<span>
										<xsl:text>Восточной долготы</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th>
									<span>
										<xsl:text>Градус</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Минута</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Секунда</xsl:text>
									</span>
								</th>
								<th>
									<span>
