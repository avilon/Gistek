...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;20050&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="20050_rpt.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения об отгрузке нефтепродуктов с нефтеперерабатывающих заводов, пунктов налива и нефтебаз</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Производство нефтепродуктов</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование производителя нефтепродукта</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование нефтепродукта</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Объем производства, т</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
							...
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdataPart1">
											<tr>
												<td>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Отгрузка нефтепродуктов</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование пункта отгрузки</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Вида транспорта отгрузки</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Субъект РФ грузополучателя (при отгрузке на внутренний рынок)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Страна грузополучатель (при экспорте)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Вид транспорта на границе (при экспорте)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Код органа выезда (при экспорте)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Объем отгрузки, т</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdataPart2">
											<tr>
												<td>
													<xsl:for-each select="@col3">
														<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Остатки нефтепродуктов</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Остатки нефтепродукта на начало месяца, т</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Остатки нефтепродукта на конец месяца, т</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdataPart3">
											<tr>
												<td>
													<xsl:for-each select="@col3">
														<span>
