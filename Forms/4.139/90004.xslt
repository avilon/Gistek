...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;90004&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="90004.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о распределении числа пострадавших при несчастных случаях на производстве</xsl:text>
				</span>
				<br/>
				<span style="font-size:16pt; ">
					<xsl:text>за _______ квартал 20____ года</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Число пострадавших по видам происшествий, опасных факторов</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Число пострадавших за аналогичный период предыдущего года, чел.</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Число пострадавших со смертельным исходом за аналогичный период предыдущего года, чел.</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Число пострадавших с начала текущего года, чел.</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Число пострадавших со смертельным исходом с начала текущего года, чел.</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Число пострадавших в разрезе причин возникновения несчастных случаев</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Число пострадавших в дорожно-транспортных происшествиях</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
				...
				<br/>
				<span>
					<xsl:text>Раздел 4. Число пострадавших в разрезе возрастных групп</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
				...
				<br/>
				<span>
					<xsl:text>Раздел 5. Число пострадавших в разрезе стажа работы по профессии</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
				...
				<br/>
				<span>
					<xsl:text>Раздел 6. Число пострадавших по дням недели</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata_06">
											<tr>
												<td>
													<xsl:for-each select="@name">
														<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 7. Число пострадавших в разрезе пола</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata_07">
											<tr>
												<td>
													<xsl:for-each select="@name">
														<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 8. Число пострадавших по видам предприятий</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata_08">
											<tr>
												<td>
													<xsl:for-each select="@name">
														<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 9. Число пострадавших в разрезе видов работ</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata_09">
											<tr>
												<td>
													<xsl:for-each select="@name">
														<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 10. Число пострадавших в разрезе категории работников</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata_10">
											<tr>
												<td>
													<xsl:for-each select="@name">
														<span>
