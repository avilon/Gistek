...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20083_rpt.xsd" workingxmlfile="20083_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения по показателям сдаваемой нефти и газового конденсата">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения по показателям сдаваемой нефти и газового конденсата"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Пункт отправления"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Факт сдачи нефти из системы МН за отчетный период, "/>
													<newline/>
													<text fixtext="т"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Температура нефти при условиях измерений объема, "/>
													<newline/>
													<text fixtext="°C"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Давление нефти при условиях измерений объема, "/>
													<newline/>
													<text fixtext="МПа"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Плотность нефти при температуре и давлении в условиях измерений объема, "/>
													<newline/>
													<text fixtext="кг/куб. м"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Плотность нефти при температуре 20 °C, "/>
													<newline/>
													<text fixtext="кг/куб. м"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Плотность нефти при 15 °C, "/>
													<newline/>
													<text fixtext="кг/куб. м"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Массовая доля воды, "/>
													<newline/>
													<text fixtext="%"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Массовая концентрация (массовая доля) хлористых солей, "/>
													<newline/>
													<text fixtext="мг/куб. дм"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Массовая доля механических примесей, "/>
													<newline/>
													<text fixtext="%"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Массовая доля серы, %"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Давление насыщенных паров, "/>
													<newline/>
													<text fixtext="кПа"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Давление насыщенных паров, "/>
													<newline/>
													<text fixtext="мм рт. ст."/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Выход фракций при температуре до 200 °C, "/>
													<newline/>
													<text fixtext="%"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Массовая доля парафина, "/>
													<newline/>
													<text fixtext="%"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Массовая доля сероводорода, млн.-1 (ppm)"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Массовая доля метил- и этилмеркаптанов в сумме, "/>
													<newline/>
													<text fixtext="млн.-1 (ppm)"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Массовая доля органических хлоридов, "/>
													<newline/>
													<text fixtext="млн.-1 (ppm)"/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Объемная доля свободного газа, "/>
													<newline/>
													<text fixtext="%"/>
													<newline/>
												</children>
