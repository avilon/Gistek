...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE7" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="10526.xsd" workingxmlfile="10526.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
					...
					<template subtype="source" match="XML">
						<children>
							<paragraph paragraphtag="pre">
								...
								<children>
									<text fixtext="Приложение № 4.146.1">
												...
												<children>
													<tgridcell>
														<children>
															<paragraph paragraphtag="center">
																<children>
																	<text fixtext="Списки оперативного персонала субъектов электроэнергетики и потребителей электрической энергии, допущенных к производству оперативных переключений и ведению оперативных переговоров с диспетчерским персоналом субъектов оперативно-диспетчерского управления в электроэнергетике">
																		<styles font-family="Times New Roman" font-size="12pt" font-weight="bold"/>
																	</text>
																</children>
															</paragraph>
										...
										<children>
											...
											<tgridrow>
												<children>
													...
													<tgridcell>
														<children>
															<text fixtext="до 1 января каждого года">
																<styles font-family="Times New Roman" font-size="12pt"/>
															</text>
														</children>
													</tgridcell>
														...
														<children>
															<paragraph paragraphtag="center">
																<children>
																	...
																	<newline/>
																	<text fixtext=" по мере изменения списков">
																		<styles font-family="Times New Roman" font-size="12pt"/>
																	</text>
																	<newline/>
																</children>
							...
							<text fixtext="Раздел 1. Списки оперативного персонала субъектов электроэнергетики, взаимодействующего с диспетчерским персоналом субъектов оперативно-диспетчерского управления">
								<styles font-family="Times New Roman" font-size="12pt"/>
							</text>
							<newline/>
							<tgrid>
											...
											<tgridrow>
												<children>
													...
													<tgridcell>
														<styles text-align="center"/>
														<children>
															<text fixtext="Телефон (с кодом города)">
																<styles font-family="Times New Roman" font-size="12pt"/>
															</text>
														</children>
													</tgridcell>
										...
										<children>
											<template subtype="element" match="document">
												<children>
													<template subtype="element" match="flat">
														<children>
															<template subtype="element" filter="@col1 ne &quot;&quot;" match="strdata">
																<children>
																	<tgridrow>
																		<children>
																			<tgridcell>
