...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="1074_rpt.xsd" workingxmlfile="1074_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Баланс обогащения углей">
					...
					<newline/>
					<newline/>
					<text fixtext="Раздел 1. Баланс обогащения углей "/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Обогащение "/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
												<children>
													<text fixtext="Зольность "/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="План (тыс.т) "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Факт (тыс.т) "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
