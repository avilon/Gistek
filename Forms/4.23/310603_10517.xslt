...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;310603_10517&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="310603_10517_final.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.23.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
									...
									<td style="text-align:center; ">
										<center style="text-align:center; ">
											<span style="font-weight:bold; ">
												<xsl:text>Предложения субъектов электроэнергетики по включению средств диспетчерско-технологического управления, участвующих в организации диспетчерской телефонной связи, системы сбора и передачи телеинформации и отнесенных к объектам диспетчеризации, в сводные графики (годовой и месячные) ремонта и технического обслуживания объектов диспетчеризации, утверждаемые субъектом оперативно-диспетчерского управления в электроэнергетике</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span>
												<xsl:text>Шифр формы: 4.23.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								...
								<tr style="height:0.36in; ">
									<td width="25%">
										<center>
											<span>
												<xsl:text>до 1-го числа месяца, предшествующего планируемому периоду</xsl:text>
											</span>
										</center>
									</td>
									<td width="25%">
						...
						<table border="1">
							...
							<thead align="center" valign="middle">
								<tr style="height:0.01in; ">
									<th rowspan="2" style="width:2.93in; ">
										<span>
									...
									<th rowspan="2" style="width:2.93in; ">
										<span>
											<xsl:text>Наименование устройства СДТУ</xsl:text>
										</span>
									</th>
									<th rowspan="2" style="width:2.93in; ">
										<span>
											<xsl:text>Наименование комплекса противоаварийной или режимной автоматики</xsl:text>
										</span>
									</th>
									<th rowspan="2" style="width:2.93in; ">
										<span>
											<xsl:text>Объект, диспетчерский центр(ы) субъекта оперативно-диспетчерского управления в электроэнергетике, в диспетчерском управлении или диспетчерском ведении которых находится устройство СДТУ</xsl:text>
										</span>
									</th>
									<th rowspan="2" style="width:2.93in; ">
										<span>
											<xsl:text>Цикл проверки устройств СДТУ (лет)</xsl:text>
										</span>
									</th>
									<th rowspan="2" style="width:3.18in; ">
										<span>
											<xsl:text>Дата последнего ТО, восстановления (наладки)</xsl:text>
										</span>
									</th>
									<th colspan="3" style="width:2.93in; ">
										<span>
											<xsl:text>Планируемое обслуживание, дата обслуживания (ДД.ММ.ГГГГ)</xsl:text>
										</span>
									</th>
									<th colspan="2" style="width:1.49in; ">
										<span>
											<xsl:text>Согласованные сроки обслуживания (ДД.ММ.ГГГГ)</xsl:text>
										</span>
									</th>
									<th colspan="2" style="width:1.05in; ">
										<span>
											<xsl:text>Фактические сроки обслуживания (ДД.ММ.ГГГГ)</xsl:text>
										</span>
									</th>
								</tr>
								<tr style="height:1.33in; ">
									<th style="width:2.93in; ">
										<span>
											<xsl:text>вид обслужи</xsl:text>
										</span>
										<br/>
										<span>
											<xsl:text>вания</xsl:text>
										</span>
									</th>
									<th style="width:1.58in; ">
										<span>
											<xsl:text>начало</xsl:text>
										</span>
									</th>
									<th style="width:1.44in; ">
										<span>
											<xsl:text>окончание</xsl:text>
										</span>
									</th>
									<th style="width:1.49in; ">
										<span>
											<xsl:text>начало</xsl:text>
										</span>
									</th>
									<th style="width:1.45in; ">
										<span>
											<xsl:text>окончание</xsl:text>
										</span>
									</th>
									<th style="width:1.05in; ">
										<span>
											<xsl:text>начало</xsl:text>
										</span>
									</th>
								...
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata">
											<tr style="height:0.77in; ">
												<td style="width:2.93in; ">
