...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20114_rpt.xsd" workingxmlfile="20114_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения об остатках углеводородного сырья и основных продуктов">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения об остатках углеводородного сырья "/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Наименование углеводородного сырья"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Полезный остаток"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Свободные емкости"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
					...
					<newline/>
					<text fixtext="Раздел 2. Сведения об остатках основных продуктов"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Основные продукты"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Объем остатков товара"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Объем остатков компонент продуктов"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
