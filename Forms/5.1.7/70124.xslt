...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;70124&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="70124.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сводная форма мониторинга реализации программы энергосбережения и повышения энергетической эффективности организаций, осуществляющих регулируемые виды деятельности</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2 Затраты на реализацию программы</xsl:text>
				</span>
				<br/>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1" width="100%">
						...
						<tbody>
							<tr>
								...
								<td rowspan="4" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>План/факт/отклонение</xsl:text>
									</span>
									<br/>
								</td>
								<td rowspan="4" style="text-align:center; width:0.38in; ">
									<span style="font-weight:bold; ">
										<xsl:text>Код строки</xsl:text>
									</span>
									<br/>
								...
								<td colspan="2" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>Затраты, млн. руб. без НДС	</xsl:text>
									</span>
									<br/>
									<span style="font-weight:bold; ">
										<xsl:text>	</xsl:text>
								...
								<td rowspan="4" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>Доля затрат в инвестиционной программе, направленной на реализацию целевых мероприятий в области энергосбережения и повышения энергетической эффективности, %</xsl:text>
									</span>
									<br/>
									<br/>
								</td>
							...
							<tr>
								...
								<td rowspan="3" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>в т. ч. </xsl:text>
									</span>
									<br/>
									<span style="font-weight:bold; ">
										<xsl:text>капитальные</xsl:text>
									</span>
									<br/>
								</td>
							...
							<tr>
								...
								<td style="text-align:center; width:0.38in; ">
									<span style="font-weight:bold; ">
										<xsl:text>В</xsl:text>
									</span>
								</td>
							...
							<tr>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=6]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr style="height:0.18in; ">
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=7]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td rowspan="3" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>нарастающим итогом</xsl:text>
									</span>
									<br/>
								</td>
								<td>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=8]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=9]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr style="height:0.23in; ">
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=10]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
