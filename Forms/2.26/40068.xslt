...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;40068&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="40068.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о добыче газа на месторождениях, в том числе на условиях льготного налогообложения</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о добыче газа, облагаемой по полной ставке НДПИ</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Объем добычи за отчетный месяц, тыс. куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Объем добычи с начала года, тыс. куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Объем добычи с начала разра-ботки, тыс. куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Сведения о добыче газа, облагаемой по льготной ставке НДПИ</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Степень выработанности месторожде-ния, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Объем добычи с начала разработки, тыс. куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Применяемая ставка НДПИ, руб./тыс. куб. м</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Кате-гория 1 льго-ты по став-ке НДПИ</xsl:text>
									</span>
								</th>
								<th>
									<span>
					...
					<table border="1" width="100%">
						...
						<tbody>
							<tr>
								<td>
									<span>
										<xsl:text>Полное наименование отчитывающейся организации</xsl:text>
									</span>
								</td>
								<td/>
							</tr>
