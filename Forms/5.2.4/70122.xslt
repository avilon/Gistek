	...
	<xsl:template name="altova:Root">
		<html>
			...
			<body>
				...
				<hr/>
				<span>
					<xsl:text>Раздел  1 Сведения о целевых показателях и индикаторах государственных программ субъектов Российской Федерации</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="22">
									<span>
										<xsl:text>Значение целевого показателя									</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
							<tr>
								...
								<th colspan="2">
									<span>
										<xsl:text>Индикаторы, используемые для расчета целевого показателя	</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
									...
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata">
											<tr>
												...
												<td>
													<xsl:variable name="altova:table">
														<table style="border-bottom-style:none; border-collapse:collapse; border-style:none; margin-bottom:0; margin-left:0; margin-right:0; margin-top:0; padding-left:0; padding-right:0; padding-top:0; text-align:center; vertical-align:middle; " align="center" border="2" altova:hide-rows="empty" altova:hide-cols="empty">
															<xsl:variable name="altova:CurrContextGrid_1" select="."/>
															<xsl:variable name="altova:ColumnData"/>
															<tbody style="border-style:none; empty-cells:hide; vertical-align:middle; ">
																<xsl:for-each select="child">
																	<tr style="border-style:none; empty-cells:hide; height:1.50in; ">
																		<td style="border-bottom-style:solid; border-style:solid; top:inherit; vertical-align:middle; width:160px; ">
																			<xsl:for-each select="@nameInd">
