...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10445&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10445.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.105.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Сведения по реализации на потребительском рынке электрической энергии (мощности), предоставляемой участниками оптового рынка - энергосбытовыми компаниями, гарантирующими поставщиками</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.105.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
						...
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr style="height:0.81in; ">
									<td width="50%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>организации, оказывающие услуги по проведению финансовых расчетов между участниками оптового рынка электрической энергии</xsl:text>
										</span>
									</td>
									<td style="text-align:center; " width="25%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>до 5 числа второго месяца, следующего за отчетным</xsl:text>
										</span>
									</td>
									<td width="25%">
										<center>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Информация по реализации на потребительском рынке электрической энергии (мощности) участниками оптового рынка - энергосбытовыми компаниями, гарантирующими поставщиками </xsl:text>
					</span>
					<br/>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Наименование участника:_______________________________</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Код участника:______________________________________</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Период (месяц):____________________ 20__ г.</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
							...
							<tbody>
								<tr>
									<td style="text-align:right; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>с НДС, тыс. рублей</xsl:text>
										</span>
									</td>
								</tr>
							</tbody>
								...
								<tr>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Группы потребителей</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Фактический отпуск электроэнергии в натуральном выражении за отчетный период, тыс. кВт•ч</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Задолженность на начало отчетного периода (сальдо), тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т. ч. кредиторская задолженность на начало отчетного периода ВСЕГО (остаток авансовых платежей на начало отчетного периода полученных за энергию), тыс. руб</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т. ч. дебиторская задолженность на начало отчетного периода ВСЕГО, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Фактические начисления за электроэнергию (мощность) за отчетный период, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Фактическая сумма поступивших платежей за отчетный период, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Реализация продукции за отчетный период, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Списано безнадежной&#160; задолженности за отчетный период, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>%&#160; оплаты за отчетный период</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>% реализации за отчетный период</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Задолженность на конец отчетного периода (сальдо), тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т. ч. кредиторская задолженность на конец отчетного периода ВСЕГО (остаток авансовых платежей на конец отчетного периода полученных за энергию), тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т. ч. дебиторская задолженность на конец отчетного периода ВСЕГО, тыс. руб.</xsl:text>
										</span>
									</th>
									<th colspan="7" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Дебиторская задолженность на конец отчетного периода ВСЕГО, в т.ч.:</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
									<th rowspan="3" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Текущая</xsl:text>
										</span>
									</th>
									<th rowspan="3" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Реструктурированная</xsl:text>
										</span>
									</th>
									<th colspan="5" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Просроченная</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
									<th colspan="3" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Рабочая</xsl:text>
										</span>
									</th>
									<th rowspan="2" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Мораторная</xsl:text>
										</span>
									</th>
									<th rowspan="2" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Безнадежная</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Прочая просроченная</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Исковая</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
						...
						<table border="1" width="100%">
							...
							<thead>
								<tr>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Расчеты с контрагентами</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
									...
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Задолженность на начало отчетного периода,&#160; тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т.ч. дебиторская задолженность (Остаток авансовых платежей на начало отчетного периода) ВСЕГО, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т.ч. Кредиторская задолженность на начало отчетного периода ВСЕГО, тыс. руб</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Фактические начисления за отчетный период, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Фактическая сумма перечисленных средств в отчетном периоде, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
									...
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Задолженность на конец отчетного периода, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т.ч. дебиторская задолженность (Остаток авансовых платежей на конец отчетного периода) ВСЕГО, тыс. руб.</xsl:text>
										</span>
									</th>
									<th rowspan="4" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>В т.ч. Кредиторская задолженность на конец отчетного периода ВСЕГО, тыс. руб.</xsl:text>
										</span>
									</th>
									<th colspan="7" style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:8pt; ">
											<xsl:text>Кредиторская задолженность на конец отчетного периода, в т. ч.:</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
