...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20019_rpt.xsd" workingxmlfile="20019_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о потерях нефтепродуктов в системе магистрального трубопроводного транспорта">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о потерях нефтепродуктов в системе магистрального трубопроводного транспорта "/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Нефтепродукты"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Потери - всего, т"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Потери при транспортировке на внутренний рынок, т"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Потери при транспорти-ровке на экс-порт, т"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
