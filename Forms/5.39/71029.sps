...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="71029.xsd" workingxmlfile="71029.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
			...
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<paragraph paragraphtag="pre">
						...
						<children>
							<text fixtext="Приложение № 5.39.1">
										...
										<children>
											<tgridcell>
												<children>
													<paragraph paragraphtag="center">
														<children>
															<text fixtext="Показатели энергетической эффективности объектов, создание или модернизация которых планируется инвестиционными программами субъектов естественных монополий, оказывающих услуги по использованию инфраструктуры внутренних водных путей, за 20__ г.">
					...
					<newline/>
					<newline/>
					<text fixtext="Раздел 1. Показатели энергетической эффективности объектов, создание или модернизация которых планируется инвестиционными программами регулируемой организации"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<styles border-bottom-style="double"/>
												<children>
													<text fixtext="Б"/>
												</children>
											</tgridcell>
																	...
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				...
																				<children>
																					<template subtype="userdefined" match="if (string-length(@code)&gt;0) then 
(
  if (number(@code) = 3) then @measure else &quot;&quot;
) else &quot;&quot;">
																						<children>
																							<content subtype="regular"/>
																						</children>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_plan_downto_1">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_fact_downto_1">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_plan">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_fact">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_plan_to_1">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="year_fact_to_1">
																						<children>
																							<content subtype="regular"/>
																						</children>
																						<variables/>
