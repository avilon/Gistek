...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;71018&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="71018.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
			...
			<body>
				<pre style="text-align:right; ">
					<span style="font-family:Times New Roman; padding-left:inherit; ">
						<xsl:text>Приложение № 5.9.1</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; padding-left:inherit; ">
								...
								<td>
									<center>
										<span style="font-weight:bold; ">
											<xsl:text>Целевые показатели энергосбережения и повышения энергетической эффективности, достижение которых должно быть обеспечено в ходе реализации программ в области энергосбережения и повышения энергетической эффективности субъектов естественных монополий, оказывающих услуги по использованию инфраструктуры внутренних водных путей, за 20__ г.</xsl:text>
										</span>
									</center>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td>
									<center>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Шифр формы: 5.9</xsl:text>
										</span>
									</center>
								</td>
							</tr>
						...
						<tbody>
							...
							<tr style="height:0.43in; ">
								...
								<td width="25%">
									<center>
										<span>
											<xsl:text>не реже одного раза в 3 года</xsl:text>
										</span>
									</center>
								</td>
							</tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 1. Целевые показатели энергосбережения и повышения энергетической эффективности, достижение которых должно быть обеспечено в ходе реализации программы в области энергосбережения и повышения энергетической эффективности регулируемой организации</xsl:text>
				</span>
				<br/>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="5">
									<span>
										<xsl:text>Установленные значения целевых показателей</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
