...
declare function util:pre70121($doc) {     
  ...
  return (
        ...
        (
          for $elm in $cls
            ...
            return
            element {xs:QName("strdata_01")} {
                attribute name {concat("- ", string($elm/@name))},
                attribute code {number ( $elm/@code ) - 100000 * number($strData/@code) },
  ...
  let $data_04 := for $strData in $oldXML//strdata[number(@code) =40]
  let $colData := $strData/column             
  let $cls := $strData/strdetail
  ...
  return (
        ...
        (
          for $elm in $cls
            ...
            element {xs:QName("strdata_04")} {
                attribute name {concat(" - ", string($elm/@code))},
                attribute code {number ( $elm/@code ) - 4000000 },
                attribute id {number ( $elm/@id )},
