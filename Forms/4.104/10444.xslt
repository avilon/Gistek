...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10444&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10444.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.104.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Сведения о требованиях (обязательствах) на оптовом рынке, фактических платежах и задолженности покупателя оптового рынка</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.104.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								...
								<tr style="height:0.81in; ">
									...
									<td style="text-align:center; " width="25%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>до 25-го числа месяца, следующего за отчетным</xsl:text>
										</span>
									</td>
									<td width="25%">
										<center>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Сведения о расчетах участника оптового рынка электрической энергии и мощности за отчетный период</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr>
									<td style="width:2.53in; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Отчетный период:</xsl:text>
										</span>
									</td>
									<td/>
								</tr>
					...
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									<th style="text-align:center; width:1.08in; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Полное наименование участника</xsl:text>
										</span>
									</th>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Период обязательств</xsl:text>
										</span>
									</th>
									<th style="text-align:center; width:0.54in; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Сумма обязательств/ требований с датой оплаты в отчетном периоде,</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>руб. (с НДС)</xsl:text>
										</span>
										<br/>
									</th>
									<th style="text-align:center; width:0.73in; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Исполнено обязательств/ требований в отчетном периоде,</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>руб. (с НДС)</xsl:text>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>В т.ч. в счет погашения задолженности за предыдущие периоды,</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>руб. (с НДС)</xsl:text>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Прирост/снижение задолженности за отчетный период,</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>руб. (с НДС)</xsl:text>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Задолженность итого на конец отчетного периода,</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>руб. (с НДС)</xsl:text>
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata[@col1 ne &quot;&quot; and @col2 ne &quot;&quot; and @col3 ne &quot;&quot;]">
											<tr>
												<td style="width:1.08in; ">
												...
												<td style="text-align:right; width:0.54in; ">
												...
												<td style="text-align:right; width:0.73in; ">
