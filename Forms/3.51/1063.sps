...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="1063_rpt.xsd" workingxmlfile="1063_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения об отгрузке товаров и услуг по основным видам деятельности ">
					...
					<newline/>
					<newline/>
					<text fixtext="Раздел 1. Сведения об отгрузке товаров и услуг по основным видам деятельности."/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
										...
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="за  "/>
													<newline/>
													<text fixtext="отчетный квартал "/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="за соответствующий "/>
													<newline/>
													<text fixtext="квартал прошлого "/>
													<newline/>
													<text fixtext="года "/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="с начала "/>
													<newline/>
													<text fixtext="отчетного года "/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="за  соответствующий период с начала прошлого года "/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
