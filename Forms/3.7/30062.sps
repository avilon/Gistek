...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="30062.xsd" workingxmlfile="30062.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<newline/>
					<text fixtext="Информация о потребностях субъектов Российской Федерации в угольной продукции">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<text fixtext="на 20 ___ г.">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<newline/>
					<text fixtext="Раздел 1. Сведения о потребностях субъектов Российской Федерации в угольной продукции"/>
					<newline/>
					<text fixtext="Коды по ОКЕИ: тысяча тонн – 169, чел. – 792"/>
					<newline/>
					<newline/>
					<tgrid>
						<properties border="1"/>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Наименование субъекта Российской Федерации"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Код субъекта Российской Федерации"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Потребности субъекта Российской Федерации в угольной продукции в плановом году, тыс. тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Заключено договоров на поставку угля в плановом году, тыс. тонн"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
