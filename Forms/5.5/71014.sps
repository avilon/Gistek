...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="71014.xsd" workingxmlfile="71014.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
										...
										<children>
											<tgridcell>
												<children>
													<paragraph paragraphtag="center">
														<children>
															<text fixtext="Целевые показатели энергосбережения и повышения энергетической эффективности, достижение которых должно быть обеспечено в ходе реализации программ в области энергосбережения и повышения энергетической эффективности субъектов естественных монополий, оказывающих услуги в аэропортах, за 20__ г.">
