...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30005&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30005.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
			...
			<body>
				<pre style="text-align:right; ">
					<span style="font-family:Times New Roman; padding-left:inherit; ">
						<xsl:text>Приложение № 3.16</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; padding-left:inherit; ">
								...
								<td>
									<center>
										<span style="font-weight:bold; ">
											<xsl:text>Сведения о вводе оборудования</xsl:text>
										</span>
									</center>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								<td width="50%">
									<center>
										<span>
											<xsl:text>Сегмент в области угольной промышленности, сланцевой промышленности, торфяной промышленности</xsl:text>
										</span>
									</center>
								</td>
								<td>
									<center>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Шифр формы: 3.16.</xsl:text>
										</span>
									</center>
								</td>
							</tr>
					...
					<table border="1" width="100%">
						...
						<tbody>
							...
							<tr style="height:0.43in; ">
								<td width="50%">
									<span>
										<xsl:text>организации, осуществляющие добычу угля, сланца&#160; </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>в адрес уполномоченной организации ГИС ТЭК</xsl:text>
									</span>
									<br/>
								</td>
								<td width="25%">
									<span>
										<xsl:text>На 25-й день месяца, следующего за отчетным периодом</xsl:text>
									</span>
								</td>
								<td width="25%">
									<center>
										<span>
											<xsl:text>ежеквартально</xsl:text>
										</span>
									</center>
								</td>
							</tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 1. Сведения о вводе основного оборудования по видам техники</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							...
							<tr>
								<th>
									<span>
										<xsl:text>Ввод импортного оборудования</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Ввод отечественного оборудования</xsl:text>
									</span>
								</th>
								<th>
									<span>
					...
					<table border="1">
						...
						<thead>
							...
							<tr>
								<th>
									<span>
										<xsl:text>БелАЗ</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Ввод импортных автосамосвалов</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<xsl:variable name="altova:table">
					<table border="1" width="100%">
						...
						<tbody>
							<tr>
								<td rowspan="3" style="text-align:center; width:1.76in; ">
									<span style="font-weight:bold; ">
										<xsl:text>Наименование оборудования</xsl:text>
									</span>
								</td>
								<td rowspan="3" style="text-align:center; width:0.68in; ">
									<span style="font-weight:bold; ">
										<xsl:text>Код строки</xsl:text>
									</span>
								</td>
								<td colspan="2" style="text-align:center; width:1.77in; ">
									<span style="font-weight:bold; ">
										<xsl:text>За квартал</xsl:text>
									</span>
								</td>
								<td colspan="2" style="text-align:center; width:1.76in; ">
									<span style="font-weight:bold; ">
										<xsl:text>С начала года</xsl:text>
									</span>
								</td>
							...
							<tr>
								<td style="text-align:center; width:1.77in; ">
									<span>
										<xsl:text>Э</xsl:text>
									</span>
									<span style="font-weight:bold; ">
										<xsl:text>лектровозы, тепловозы</xsl:text>
									</span>
								</td>
								<td style="text-align:center; width:1.43in; ">
									<span style="font-weight:bold; ">
										<xsl:text>Думпкары, вагоны</xsl:text>
									</span>
								</td>
								<td style="text-align:center; width:1.76in; ">
									<span style="font-weight:bold; ">
										<xsl:text>Электровозы тепловозы</xsl:text>
									</span>
								</td>
							...
							<tr>
								<td style="width:1.76in; ">
									<span>
										<xsl:text>Железнодорожный подвижной состав</xsl:text>
									</span>
								</td>
								<td style="width:0.68in; ">
									<span>
										<xsl:text>16</xsl:text>
									</span>
								</td>
								<td style="width:1.77in; ">
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="list_03[@code = 36]">
													<xsl:for-each select="@quart_tot">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
								...
								<td style="width:1.43in; ">
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="list_03[@code = 27]">
													<xsl:for-each select="@quart_tot">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="list_03[@code = 37]">
													<xsl:for-each select="@year_tot">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
				...
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2" style="width:2.02in; ">
									<span>
										<xsl:text>Наименование оборудования</xsl:text>
									</span>
								</th>
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="list_04">
											<tr>
												<td style="width:2.02in; ">
													<xsl:for-each select="@name">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
