...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20034_rpt.xsd" workingxmlfile="20034_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о планах по первичной переработке и выработке основных продуктов">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о планах по первичной переработке и выработке основных продуктов (квартальная форма)"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="месяц 1"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="месяц 2"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="месяц 3"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
					...
					<newline/>
					<newline/>
					<text fixtext="Раздел 2. Сведения о планах по первичной переработке и выработке основных продуктов (годовая форма)"/>
					<tgrid>
						<properties border="1"/>
						<children>
							<tgridbody-cols>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="сентябрь"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="октябрь"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
