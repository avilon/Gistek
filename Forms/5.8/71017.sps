...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="71017.xsd" workingxmlfile="71017.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
										...
										<children>
											<tgridcell>
												<children>
													<paragraph paragraphtag="center">
														<children>
															<text fixtext="Целевые показатели энергосбережения и повышения энергетической эффективности, достижение которых должно быть обеспечено в ходе реализации программ в области энергосбережения и повышения энергетической эффективности субъектов естественных монополий, оказывающих услуги по использованию инфраструктуры внутренних водных путей, за 20__ г.">
										...
										<children>
											...
											<tgridcell>
												<children>
													<paragraph paragraphtag="center">
														<children>
															<text fixtext="не реже одного раза в 3 года"/>
														</children>
													</paragraph>
												</children>
											</tgridcell>
					...
					<newline/>
					<newline/>
					<text fixtext="Раздел 1. Целевые показатели энергосбережения и повышения энергетической эффективности, достижение которых должно быть обеспечено в ходе реализации программы в области энергосбережения и повышения энергетической эффективности регулируемой организации"/>
					<newline/>
					<newline/>
					<tgrid>
						<properties border="1"/>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Установленные значения целевых показателей"/>
												</children>
											</tgridcell>
