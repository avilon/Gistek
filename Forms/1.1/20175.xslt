...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;20175&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="20175.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Общие сведения об организации нефтяной промышленности</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Анкетные данные о предприятии</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Сведения о предприятии</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Изменение относительно предыдущего отчета (Да/Нет)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Описание изменения относительно предыдущего отчета</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Сведения об учредителях предприятия</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование или Ф.И.О. учредителя предприятия</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Местоположение (Страна)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Доля участия в уставном капитале, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Сведения о текущих акционерах предприятия, в т.ч. о головной компании</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование или Ф.И.О. акционера предприятия</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Доля участия в капитале, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 4. Сведения о руководстве предприятия</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование параметра</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Год рождения</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Предыдущие места работы</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Описание из-менения от-носительно предыдущего отчета</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 5. Дочерние и зависимые общества предприятия</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Наименование территориально-обособленного подразделения</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Дочернее или зависимое общество (Да/Нет)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Имеет статус филиала (Да/Нет)</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Описание из-менения относительно предыдущего отчета</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 6. Сведения о лицензиях на осуществление профессиональной деятельности (при наличии)</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Выдавший офици-альный орган</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 7. Сведения о сотрудниках предприятия за последний календарный год</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1" width="100%">
						...
						<tbody>
							...
							<tr>
								<td>
									<span>
										<xsl:text>Среднесписочная численность сотрудников, чел.,</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span>
							...
							<tr>
								<td>
									<span>
										<xsl:text>&#160;&#160;&#160;&#160;&#160; Управленческий и административный персонал</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span>
							...
							<tr>
								<td>
									<span>
										<xsl:text>&#160;&#160;&#160;&#160;&#160;&#160; Рабочий персонал</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span>
							...
							<tr>
								<td>
									<span>
										<xsl:text>Доля сотрудников, имеющих высшее профессиональное образование, %</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span>
							...
							<tr>
								<td>
									<span>
										<xsl:text>Фонд оплаты труда, тыс. руб.</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span>
							...
							<tr>
								<td>
									<span>
										<xsl:text>Объем денежных средств, направленных на социальное обеспечение, тыс. руб</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 8. Сведения о наличии территориально изолированных объектов производственной деятельности</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Категория объекта производственной деятельности</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Количество объектов, шт.</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 9. Сведения о мощностях территориально изолированных объектов производственной деятельности</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Год ввода</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Установленная мощность, тыс. т/год</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Фактическая мощность, тыс. т/год</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Вместимость хранилища, т</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
