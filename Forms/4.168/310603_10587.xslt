...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;310603_10587&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="310603_10587_final.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
			...
			<body>
				<pre style="text-align:right; ">
					<span style="font-family:Times New Roman; padding-left:inherit; ">
						<xsl:text>Приложение № 4.168.1</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tr>
								<td style="text-align:center; ">
									<center style="text-align:center; ">
										<span>
											<xsl:text>Сведения о работе электросетей</xsl:text>
										</span>
										<br/>
										<span>
											<xsl:text>за___________ 20__ года</xsl:text>
										</span>
									</center>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td>
									<center>
										<span>
											<xsl:text>Шифр формы: 4.168.</xsl:text>
										</span>
									</center>
								</td>
							</tr>
						...
						<tbody>
							...
							<tr style="height:0.01in; ">
								...
								<td width="25%">
									<center>
										<span>
											<xsl:text>до 18 января года, следующего за отчетным</xsl:text>
										</span>
									</center>
								</td>
								<td width="25%">
				...
				<center/>
				<span style="font-family:Times New Roman; font-size:12pt; ">
					<xsl:text>Раздел 1. Сведения о показателях баланса электрической энергии в сетях территориальных сетевых организаций, сформированных по применяемым тарифам на услуги по передаче электрической энергии</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1" width="100%">
						...
						<thead align="center" valign="middle">
							<tr>
								...
								<th>
									<span>
										<xsl:text>ВН</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>СН 1</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>СН 11</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>НН</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
						...
						<tbody>
							<tr>
								...
								<td>
									<span>
										<xsl:text>Поступление электроэнергии в сеть, всего </xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>из сетей смежного уровня напряжения</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>в том числе из сети ВН</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								<td>
									<span>
										<xsl:text>1.1.2</xsl:text>
									</span>
								</td>
								<td>
									<span>
										<xsl:text>в том числе из сети СН1</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								<td>
									<span>
										<xsl:text>1.1.3</xsl:text>
									</span>
								</td>
								<td>
									<span>
										<xsl:text>в том числе из сети СН2</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>от генерирующих компаний</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>от сетей ЕНЭС</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>от смежных сетевых организаций</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>от потребителей с блок станцией</xsl:text>
									</span>
								</td>
								<td>
									<center>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>Потери электроэнергии в сети </xsl:text>
									</span>
								</td>
								<td>
									<center>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="/document">
													<xsl:for-each select="flat">
														<xsl:for-each select="strdata[10]">
															<xsl:for-each select="@id">
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
							...
							<tr style="height:0.22in; ">
								...
								<td>
									<span>
										<xsl:text>то же в % (п.2/п.1)</xsl:text>
									</span>
								</td>
								<td>
									<center>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="/document">
													<xsl:for-each select="flat">
														<xsl:for-each select="strdata[11]">
															<xsl:for-each select="@id">
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
							...
							<tr style="height:0.39in; ">
								...
								<td>
									<span>
										<xsl:text>Расход электроэнергии на производственные и (или) хозяйственные нужды</xsl:text>
									</span>
								</td>
								<td>
									<center>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="/document">
													<xsl:for-each select="flat">
														<xsl:for-each select="strdata[12]">
															<xsl:for-each select="@id">
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>Полезный отпуск из сети по применяемым тарифам</xsl:text>
									</span>
								</td>
								<td>
									<center>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="/document">
													<xsl:for-each select="flat">
														<xsl:for-each select="strdata[13]">
															<xsl:for-each select="@id">
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>нижестоящим сетевым организациям</xsl:text>
									</span>
								</td>
								<td>
									<center>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="/document">
													<xsl:for-each select="flat">
														<xsl:for-each select="strdata[14]">
															<xsl:for-each select="@id">
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
							...
							<tr style="height:0.99in; ">
								...
								<td>
									<span>
										<xsl:text>потребителям, юридическим лицам и ИП, не оказывающим услуги по передаче электроэнергии</xsl:text>
									</span>
								</td>
								<td>
									<center>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="/document">
													<xsl:for-each select="flat">
														<xsl:for-each select="strdata[15]">
															<xsl:for-each select="@id">
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
							...
							<tr>
								...
								<td>
									<span>
										<xsl:text>населению и приравненным к нему потребителям</xsl:text>
									</span>
								</td>
								<td>
									<center>
									...
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="/document">
													<xsl:for-each select="flat">
														<xsl:for-each select="strdata[16]">
															<xsl:for-each select="@id">
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
