...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;70117&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="70117.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Перечень мероприятий программы энергосбережения и повышения энергетической эффективности организаций с участием государства и муниципального образования</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о&#160; мероприятиях программы энергосбережения и повышения энергетической эффективности организации</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="4">
									<span>
										<xsl:text>Наименование мероприятия програв нммы</xsl:text>
									</span>
								</th>
								<th rowspan="4">
									<span>
							...
							<tr>
								<th colspan="2" rowspan="2">
									<span>
										<xsl:text>финансовое обеспечение реализации мероприятий</xsl:text>
									</span>
								</th>
								<th colspan="4">
									<span>
										<xsl:text>экономия топливно-энергетических ресурсов</xsl:text>
									</span>
								</th>
								<th colspan="2" rowspan="2">
									<span>
								...
								<th colspan="4" style="width:0.47in; ">
									<span>
										<xsl:text>экономия топливно-энергетических ресурсов</xsl:text>
									</span>
								</th>
							...
							<tr>
								...
								<th colspan="2">
									<span>
										<xsl:text>в натуральном выражении</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>в стоимостном выражении, тыс.руб.</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th rowspan="2" style="width:0.47in; ">
									<span>
										<xsl:text>Вид ТЭР</xsl:text>
									</span>
								</th>
								<th colspan="2" style="width:0.47in; ">
									<span>
										<xsl:text>в натуральном выражении</xsl:text>
									</span>
								</th>
							...
							<tr>
								...
								<th>
									<span>
										<xsl:text>объем, тыс.руб.</xsl:text>
									</span>
								</th>
								<th>
									<span>
									...
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata">
											<tr>
												...
												<td>
													<span>
														<xsl:text>федеральный </xsl:text>
													</span>
													<br/>
													<span>
														<xsl:text>бюджет</xsl:text>
													</span>
												</td>
												<td>
													<xsl:for-each select="src_01">
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_downto_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_downto_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_downto_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_downto_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_downto_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_downto_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4" style="width:0.47in; ">
													<xsl:for-each select="econ">
														<xsl:for-each select="@name">
															<p>
																<span>
												...
												<td rowspan="4" style="width:0.47in; ">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_to_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_to_1">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_to_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_to_2">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_natur_to_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
												...
												<td rowspan="4">
													<xsl:for-each select="econ">
														<xsl:for-each select="@econ_cost_to_3">
															<p>
																<span>
																	<xsl:value-of select="string(.)"/>
																</span>
											...
											<tr>
												<td>
													<span>
														<xsl:text>бюджет субъекта Российской Федерации</xsl:text>
													</span>
												</td>
												<td>
													<xsl:for-each select="src_02">
														<xsl:for-each select="@vol_year_downto_3">
															<span>
																<xsl:value-of select="string(.)"/>
															</span>
											...
											<tr>
												<td>
													<span>
														<xsl:text>местные бюджеты</xsl:text>
													</span>
												</td>
												<td>
													<xsl:for-each select="src_03">
														<xsl:for-each select="@vol_year_downto_3">
															<span>
																<xsl:value-of select="string(.)"/>
															</span>
											...
											<tr>
												<td>
													<span>
														<xsl:text>внебюджетные средства</xsl:text>
													</span>
												</td>
												<td>
													<xsl:for-each select="src_04">
														<xsl:for-each select="@vol_year_downto_3">
															<span>
																<xsl:value-of select="string(.)"/>
															</span>
											...
											<tr>
												<td>
													<span>
														<xsl:text>Итого по мероприятию</xsl:text>
													</span>
												</td>
												<td/>
												<td/>
