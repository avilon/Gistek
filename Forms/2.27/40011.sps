...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="40011_rpt.xsd" workingxmlfile="40011_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о безвозвратных потерях газа при добыче">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о безвозвратных потерях газа при добыче и подготовке"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Потери, всего, тыс. куб. м (т)"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="в том числе, тыс. куб. м (т):"/>
												</children>
											</tgridcell>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Технологические потери"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Естественная убыль"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Потери при авариях"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Потери из-за несоблюдения технологической дисциплины"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
