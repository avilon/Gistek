...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="20084_rpt.xsd" workingxmlfile="20084_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о количестве нефти и газового конденсата, заявленного российскими производителями к сдаче в систему магистральных трубопроводов">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о количестве нефти и газового конденсата, заявленного российскими производителями к сдаче в систему магистральных трубопроводов"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="План сдачи за квартал, "/>
													<newline/>
													<text fixtext="тыс. т"/>
													<newline/>
												</children>
					...
					<newline/>
					<text fixtext="Раздел 2. Полученные заявки от грузоотправителей, не принятые по причине отсутствия действующего договора на оказание услуг по транспортировке нефти и газового конденсата"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
