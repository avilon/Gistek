...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="10185.xsd" workingxmlfile="10185.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Основные показатели бухгалтерского баланса">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Основные показатели бухгалтерского учета (бюджет по балансовому листу)"/>
					<newline/>
					<text fixtext="Таблица 1.1 АКТИВ"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Код строки бухгалтерского баланса"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="План, тыс. руб."/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Факт, тыс. руб."/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
					...
					<newline/>
					<text fixtext="Таблица 1.2.1 ПАССИВ"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
