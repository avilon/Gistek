...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10530_d&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10530_d.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.14.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Показатели баланса производства и потребления электрической энергии и отпуска тепловой энергии по субъектам электроэнергетики в границах субъектов Российской Федерации</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.14.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
						...
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr>
									<td style="text-align:center; " width="25%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>до 7-го числа месяца, следующего за отчетным</xsl:text>
										</span>
									</td>
									<td width="25%">
										<center>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strsubject[@id=124]">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
															<xsl:value-of select="string(.)"/>
														</span>
					...
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead>
								<tr>
									<th rowspan="3" style="text-align:center; " width="6%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>N п/п</xsl:text>
										</span>
									</th>
									<th rowspan="3" style="text-align:center; " width="45%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
									...
									<th colspan="2" style="text-align:center; " width="15%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Фактическое значение показателя</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
									<th style="text-align:center; " width="15%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>за сутки</xsl:text>
										</span>
									</th>
									<th style="text-align:center; " width="15%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>нарастающим итогом с начала месяца</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata1[(@id&gt;=1000001 and @id&lt;=1000050 and @col1 ne &quot;&quot; and @col2 ne &quot;&quot;) or
(@id&lt;=300)]">
											<tr>
												<td width="6%">
													<xsl:for-each select="if (@id&lt;300)
then (altovaext:first-chars( @name ,  3 ))
												...
												<td width="45%">
													<xsl:for-each select="if (@id&lt;300) then (altovaext:last-chars( @name ,  (string-length(@name) - altovaext:substring-pos( @name ,  &quot; &quot; )) ))
else (@name)">
														<span style="font-family:Times New Roman; font-size:12pt; ">
															<xsl:choose>
																<xsl:when test=". instance of element() or . instance of document-node()">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 2. Показатели баланса производства и потребления электрической энергии (представляется гарантирующими поставщиками и энергосбытовыми организациями). Коды по ОКЕИ: МВт*ч – 215</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata2[(@id&gt;=2000001 and @id&lt;=2000087 and @col1 ne &quot;&quot; and @col2 ne &quot;&quot;) or
(@id=20 or @id=10)]">
											<tr>
												<td width="6%">
													<xsl:for-each select="if (@id=10 or @id=20) then (altovaext:first-chars( @name ,  3 )) else (&quot;&quot;)">
														<span style="font-family:Times New Roman; font-size:12pt; ">
															<xsl:choose>
																<xsl:when test=". instance of element() or . instance of document-node()">
																	<xsl:apply-templates/>
												...
												<td width="45%">
													<xsl:for-each select="if ( @id=10 or @id=20 ) then 
altovaext:last-chars( @name ,  (string-length(@name) - altovaext:substring-pos( @name ,  &quot; &quot; )) )
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 3. Показатели баланса производства и потребления электрической энергии (представляется организацией по управлению единой национальной (общероссийской)электрической сетью и собственниками или иными законными владельцами объектов электросетевого хозяйства, входящих в единую национальную(общероссийскую)электрическую сеть, заключившими в соответствии с законодательством Российской Федерации об электроэнергетике договоры оказания услуг по передаче электрической энергии). Коды по ОКЕИ: МВт*ч – 215</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata3[(@id&gt;=201 and @id&lt;=220 and @col5 ne &quot;&quot; and @col6 ne &quot;&quot;) or
...
(@id&lt;20)]">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 4. Дата предоставления инф</xsl:text>
					</span>
					<span style="font-family:Times New Roman; ">
						<xsl:text>ормации для включения в государственную информационную систему топливно-энергетического комплекса</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
					...
					<br/>
					<span style="font-family:Times New Roman; ">
						<xsl:text>Раздел 5. Контактная информация</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
