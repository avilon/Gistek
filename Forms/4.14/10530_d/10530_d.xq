let $oldXML1:=fn:doc("338514_10530.xml")/*  
let $oldXML2:=fn:doc("338517_10532_65.xml")/*  
let $oldXML3:=fn:doc("338517_10534_65.xml")/*  
...
let $flattenPart1 :=  for $strCls in (distinct-values($oldXML1//strdata[(	number(@code)=10)
              ...
              element {xs:QName("strdata1")} {
                ...
                (
                  for $str in $oldXML1//strdata[string(@code) = $strCls]
                  let $columns:=$str/column[(	number(@id)=11)]
                  return
                    (for $c in $columns
                       return
                       attribute ed {replace($c/@name,"Факт за сутки, ","")}
                     )
                ),
                (
                  for $str in $oldXML1//strdata[string(@code) = $strCls]                  
...
let $flattenPart2 :=  for $strCls in (distinct-values($oldXML1//strdetail[(	number(@code)>=1000001
              ...
              element {xs:QName("strdata1")} {
                ...
                (
                  for $str in $oldXML1//strdetail[string(@code) = $strCls]                  
                  return
                   (for $c in $str//column[(	number(@id)=11)]/@name
                       return
                       attribute ed {replace($c,"Факт за сутки, ","")}
                     )
                ),                
                (
              ...
              element {xs:QName("strdata2")} {
                ...
                (
                  ...
                  return
                   ...
                   (for $c in $str//column[(	number(@id)=5)]/@name
                       return
                       attribute ed {replace($c,"Факт за сутки, ","")}
                     )
                ),
...
let $flattenPart5 :=  for $strCls in (distinct-values($oldXML2//strdata[(	number(@code)=20)
              ...
              element {xs:QName("strdata2")} {
                ...
                (
                  for $str in $oldXML2//strdata[string(@code) = $strCls]
                  let $columns:=$str/column[(	number(@id)=5)]
                  return
                    (for $c in $columns
                       return
                       attribute ed {replace($c/@name,"Факт за сутки, ","")}
              ...
              element {xs:QName("strdata3")} {
                ...
                (
                  ...
                  return
                   ...
                   (for $c in $str//column[(	number(@id)=76)]/@name
                       return
                       attribute ed {replace($c,"Факт за сутки, ","")}
                     )
                ),                 
