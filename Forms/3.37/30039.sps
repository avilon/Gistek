...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="30039_rpt.xsd" workingxmlfile="30039_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения об объемах отгрузки угольной продукции на экспорт">
					...
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения об объемах отгрузки угольной продукции на экспорт. "/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="в т.ч. коксующихся углей"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
										</children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Фактическая поставка"/>
													<newline/>
													<text fixtext="за"/>
													<newline/>
													<text fixtext="месяц,"/>
