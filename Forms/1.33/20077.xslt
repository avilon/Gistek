...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;20077&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="20077_rpt.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о показателях нефти и газового конденсата, сдаваемого в систему магистрального трубопроводного транспорта</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о показателях нефти и газового конденсата, сдаваемых в систему магистрального трубопроводного транспорта</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Пункт отправления</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th>
									<span>
										<xsl:text>Факт сдачи нефти в систему МН за отчетный период, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>т</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Температура нефти при условиях измерений объема, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>°C</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Давление нефти при условиях измерений объема, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>МПа</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>Плотность нефти при температуре и давлении в условиях измерений объема, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>кг/куб. м</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>Плотность нефти при температуре 20 °C, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>кг/ куб. м</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Плотность нефти при </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>15 °C, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>кг/ куб. м</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Массовая доля воды, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>%</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Массовая концентрация (массовая доля) хлористых солей, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>мг/куб. дм</xsl:text>
									</span>
									<br/>
								</th>
								<th>
								...
								<th>
									<span>
										<xsl:text>Массовая доля механических примесей, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>%</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Массовая доля серы, %</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Давление насыщенных паров, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>кПа</xsl:text>
									</span>
									<br/>
								</th>
								<th>
								...
								<th>
									<span>
										<xsl:text>Выход фракций при температуре до 200 °C, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>%</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Массовая доля парафина, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>%</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Массовая доля сероводорода, млн.-1 (ppm)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Массовая доля метил- и этилмеркаптанов в сумме, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>млн.-1 (ppm)</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>Массовая доля органических хлоридов, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>млн.-1 (ppm)</xsl:text>
								...
								<th>
									<span>
										<xsl:text>Объемная доля свободного газа, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>%</xsl:text>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Контакный телефон (с кодом города)</xsl:text>
									</span>
								</th>
								<th>
									<span>
