...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10402&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10402.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о производстве энергоносителей с использованием возобновляемых источников энергии </xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения об объекте</xsl:text>
				</span>
				<br/>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Электроэнергия</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Объем производства электроэнергии, тыс. кВт</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Объем реализации электроэнергии, тыс. кВтч</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Стоимость реализованной электроэнергии, млн. руб</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Цена электроэнергии, руб./кВт∙ч</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Продажа мощности, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>МВт</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 3. Тепловая энергия</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Объем производства тепловой энергии, Гкал</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Объем реализации тепловой энергии, Гкал</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Стоимость реализованной тепловой энергии, млн.руб.</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Цена тепловой энергии, руб/Гкал</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 4. Топливо</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Объем потребления, т у.т.</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
				...
				<br/>
				<span>
					<xsl:text>Раздел 5. Состав основного генерирующего оборудования объекта ВИЭ</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Наименование объекта генерации</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Вид ВИЭ</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Тип и марка оборудования</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Установленная мощность, кВт</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Тепловая мощность, Гкал</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Страна производитель</xsl:text>
									</span>
								</th>
								<th>
									<span>
								...
								<th>
									<span>
										<xsl:text>Дата ввода в эксплуатацию</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата модернизации (план)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата последней модернизации (факт)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата консервации (план)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата консервации (факт)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата вывода из эксплуатации (план)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Дата вывода из эксплуатации (факт)</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
