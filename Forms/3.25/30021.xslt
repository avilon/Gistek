...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30021&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30021_rpt.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о себестоимости добычи угля и сланца подземным способом</xsl:text>
				</span>
				<br/>
				<span style="font-size:16pt; ">
				...
				<hr/>
				<span>
					<xsl:text>Раздел 1. Добыча угля - всего, тыс. тонн </xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Факт за соответствующий&#160;&#160; период с начала прошлого года</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>За отчетный квартал</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Затраты на добычу угля - всего по элементам</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Факт за соотв. период&#160; с начала прош. года на 1тонну,&#160; (руб.) </xsl:text>
									</span>
								</th>
								<th colspan="2" rowspan="2">
									<span>
										<xsl:text>План на 1тонну,&#160; </xsl:text>
									</span>
								</th>
								<th colspan="4">
									<span>
							...
							<tr>
								<th>
									<span>
										<xsl:text>на отчетный квартал (руб.) </xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>с начала года (руб.) </xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>на весь&#160; объем&#160; добычи&#160; (тыс.руб.) </xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>на 1 тонну (руб.) </xsl:text>
									</span>
								</th>
								<th>
									<span>
