...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="30021_rpt.xsd" workingxmlfile="30021_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о себестоимости добычи угля и сланца подземным способом">
					...
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Добыча угля - всего, тыс. тонн "/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Факт за соответствующий   период с начала прошлого года"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="За отчетный квартал"/>
												</children>
											</tgridcell>
					...
					<newline/>
					<text fixtext="Раздел 2. Затраты на добычу угля - всего по элементам"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Факт за соотв. период  с начала прош. года на 1тонну,  (руб.) "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="План на 1тонну,  "/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="на отчетный квартал (руб.) "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="с начала года (руб.) "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="на весь  объем  добычи  (тыс.руб.) "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="на 1 тонну (руб.) "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
