...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="70113.xsd" workingxmlfile="70113.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Отчет о достижении значений целевых показателей программы энергосбережения и повышения энергетической эффективности организаций с участием государства и муниципального образования">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел  1 Сведения о достижении организацией значений целевых показателей программы энергосбережения и повышения энергетической эффективности"/>
					<newline/>
					<newline/>
					<tgrid>
						<properties border="1"/>
								...
								<children>
									<tgridrow>
										...
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Значения целевого показателя		"/>
													<newline/>
												</children>
											</tgridcell>
																...
																<children>
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="plan_val">
																						<children>
																							<content subtype="regular">
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="plan_fact">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="div_val">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
