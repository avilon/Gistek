...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30007&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30007.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о наличии и движении персонала </xsl:text>
				</span>
				<br/>
				<span style="font-size:16pt; ">
				...
				<hr/>
				<span>
					<xsl:text>Раздел 1. Сведения о наличии и движении персонала</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th colspan="8">
									<span>
										<xsl:text>Списочная численность работников на последнее число квартала</xsl:text>
									</span>
								</th>
								<th colspan="7">
									<span>
										<xsl:text>Движение списочной численности работников с начала года</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th colspan="2">
									<span>
										<xsl:text>Всего персонала </xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>По основному виду деятельности </xsl:text>
									</span>
								</th>
								<th colspan="4">
									<span>
										<xsl:text>Рабочих по добыче </xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
							...
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>из них пенсионеров </xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
								...
								<th rowspan="2">
									...
									<br/>
									<span>
										<xsl:text>руководители и специалисты </xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="2">
								...
								<th rowspan="2">
									<span>
										<xsl:text>на пенсию </xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>по сокращению и&#160; в связи с ликвидацией </xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text> по переводу </xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text> по собственному желанию </xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>по другим причинам </xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th>
									<span>
										<xsl:text>ГРОЗ (на разрезе рабочие по добыче) </xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Проходчики (на разрезе рабочие на вскрыше) </xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>другие профессии </xsl:text>
									</span>
								</th>
							</tr>
							<tr>
