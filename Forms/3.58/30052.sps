...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="30052_rpt.xsd" workingxmlfile="30052_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Данные о контрактных экспортных ценах на угольную продукцию">
					...
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Данные о контрактных экспортных ценах на угольную продукцию"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Средневзвешенная контрактная цена на угольную продукцию за отчетный месяц ($ за тонну)"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Стоимость поставок (тыс.$)"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
