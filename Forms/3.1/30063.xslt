...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30063&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30063.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:14pt; ">
					<xsl:text>Данные об авариях, несчастных случаях, связанных с авариями, и инцидентах на объектах угольной промышленности за 6 и 12 месяцев отчетного года </xsl:text>
				</span>
				<br/>
				<span style="font-size:14pt; ">
					<xsl:text>за ___ месяцев 20 ___ г.</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел 1. Данные об авариях, несчастных случаях, связанных с авариями, и инцидентах на ОПО&#160;&#160; угольной промышленности</xsl:text>
				</span>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="2">
									<span>
										<xsl:text>Число аварий на ОПО угольной промышленности, всего</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Ущерб от аварий на ОПО угольной промышленности, всего, млн. руб.</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Число инцидентов на ОПО угольной промышленности, всего</xsl:text>
									</span>
								</th>
								<th colspan="3">
									<span>
										<xsl:text>Количество травмированных в результате аварии, чел.</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								...
								<th>
									<span>
										<xsl:text>Со смертельным исходом</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>С тяжелым исходом</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
