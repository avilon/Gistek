...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;71006&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="71006.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
			...
			<body>
				<pre style="text-align:right; ">
					<span style="font-family:Times New Roman; padding-left:inherit; ">
						<xsl:text>Приложение № 5.132.1</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; padding-left:inherit; ">
								...
								<td>
									<center>
										<span style="font-weight:bold; ">
											<xsl:text>Сведения об образовании и использовании вторичных энергетических ресурсов за 20__ г.</xsl:text>
										</span>
									</center>
								</td>
							</tr>
						...
						<tbody>
							<tr>
								...
								<td>
									<center>
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Шифр формы: 5.132.</xsl:text>
										</span>
									</center>
								</td>
							</tr>
					...
					<table border="1" width="100%">
						...
						<tbody>
							...
							<tr style="height:0.43in; ">
								<td width="50%">
									<span>
										<xsl:text>федеральный орган исполнительной власти, осуществляющий регулирование в сфере официального статистического учета, формирование официальной статистической информации о социальных, экономических, демографических, экологических и других общественных процессах в Российской Федерации</xsl:text>
									</span>
									<br/>
								</td>
								<td width="25%">
									<span>
										<xsl:text>до 14 апреля года, следующего за отчетным</xsl:text>
									</span>
								</td>
								<td width="25%">
									<center>
				...
				<br/>
				<span>
					<xsl:text>Раздел 1. Вторичные горючие ресурсы</xsl:text>
				</span>
				<br/>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Код по ОКТМО</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
										<xsl:text>Вид вторичных горючих ресурсов</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
								...
								<th colspan="4">
									<span>
										<xsl:text>Выход и использование вторичных горючих ресурсов, т у. т.</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>годовой выход - всего</xsl:text>
									</span>
								</th>
								<th colspan="3">
									<span>
							...
							<tr>
								<th>
									<span>
										<xsl:text>фактически использовано</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>отпущено на сторону</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>потери</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
										...
										<xsl:for-each select="strdata_01">
											<tr>
												<td style="border-bottom-style:none; border-top-style:none; ">
													<span>
														<xsl:value-of select="if (position() = 1) then /document/flat/param/@subject else &quot;&quot;"/>
													</span>
												</td>
												<td style="border-style:none; ">
													<span>
														<xsl:value-of select="if (position() = 1) then /document/flat/param/@oktmo else &quot;&quot;"/>
													</span>
												</td>
												<td>
				...
				<br/>
				<span>
					<xsl:text>Раздел 2. Вторичные тепловые ресурсы</xsl:text>
				</span>
				<xsl:variable name="altova:table">
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Вид вторичных тепловых ресурсов</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
								...
								<th colspan="4">
									<span>
										<xsl:text>Выход и использование вторичных тепловых ресурсов, Гкал</xsl:text>
									</span>
								</th>
								<th rowspan="3">
									<span>
										<xsl:text>Фактическая экономия топлива за счет использования вторичных тепловых ресурсов, т у. т.</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>годовой выход</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>выработка тепла</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
							...
							<tr>
								<th>
									<span>
										<xsl:text>возможная</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>фактическая</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
