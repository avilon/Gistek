...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;52075&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="52075.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 1.76</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Сведения о текущих затратах на охрану окружающей среды, экологических и природоресурсных платежах за 20 ___ г.</xsl:text>
											</span>
											<br/>
										</center>
									</td>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.142.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
						...
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr style="height:0.81in; ">
									<td width="50%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>субъекты электроэнергетики, владеющие на праве собственности или на ином законном основании объектами электроэнергетики, установленная генерирующая мощность которых в совокупности равна или превышает 500 кВт (с детализацией по отдельным объектам электроэнергетики, установленная генерирующая мощность каждого из которых равна или превышает 500 кВт)</xsl:text>
										</span>
									</td>
									<td style="text-align:center; " width="25%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>до 20 февраля года, следующего за отчетным периодом</xsl:text>
										</span>
									</td>
									<td width="25%">
										<center>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Сведения о текущих затратах на охрану окружающей среды</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
							...
							<tbody>
								<tr>
									<td style="text-align:right; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Код по ОКЕИ: тысяча рублей – 384 </xsl:text>
										</span>
									</td>
								</tr>
							</tbody>
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Фактически за год, тыс. руб.</xsl:text>
										</span>
									</th>
								</tr>
								<tr>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 2. Экологические платежи</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="0" width="100%">
