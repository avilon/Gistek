...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="30004.xsd" workingxmlfile="30004.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о вводе и изменении производственных мощностей по добыче угля">
					...
					<newline/>
					<newline/>
					<text fixtext="Раздел 1. Сведения о вводе и изменении производственных мощностей по добыче угля"/>
					<newline/>
					<newline/>
					<tgrid>
						<properties border="1"/>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Мощность на 1.01 отчетного года, тыс. тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Изменение мощности за год, тыс. тонн"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
												<children>
													<text fixtext="Мощность на 1.01. года, следующего за отчетным, тыс. тонн"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Наличие основных фондов на 1.01. отчетного года, "/>
													<newline/>
											...
											<tgridcell>
												<children>
													<text fixtext="Изменение основных фондов за отчетный год, тыс. руб."/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
												<children>
													<text fixtext="Наличие основных фондов на 1.01. года, следующего за отчетным, тыс. руб."/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Незавершенное строительство на 1.01. отчетного года тыс. руб. "/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Незавершенное строительство на 1.01. года, следующего за отчетным, "/>
													<newline/>
													<text fixtext="тыс. руб. "/>
													<newline/>
												</children>
											...
											<tgridcell>
												<children>
													<text fixtext="Прогноз по вводу мощностей по добыче на год, следующий за отчетным"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
										</children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Ввод (увеличение)"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Выбытие (уменьшение)"/>
												</children>
											</tgridcell>
											<tgridcell joinabove="1"/>
											<tgridcell joinabove="1"/>
														...
														<children>
															<tgridrow>
																<children>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata21">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata22">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata3">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata4">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata51">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata52">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata6">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata7">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata8">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata9">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
																	...
																	<tgridcell>
																		<children>
																			<template subtype="element" match="strdata10">
																				<children>
																					<template subtype="attribute" match="column1">
																						<children>
																							<content subtype="regular"/>
