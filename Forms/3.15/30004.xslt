...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30004&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30004.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о вводе и изменении производственных мощностей по добыче угля</xsl:text>
				</span>
				<br/>
				<span style="font-size:16pt; ">
					<xsl:text>за _________________________20 ___ г.</xsl:text>
				</span>
				<br/>
				<hr/>
				<br/>
				<br/>
				<span>
					<xsl:text>Раздел 1. Сведения о вводе и изменении производственных мощностей по добыче угля</xsl:text>
				</span>
				<br/>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>Мощность на 1.01 отчетного года, тыс. тонн</xsl:text>
									</span>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Изменение мощности за год, тыс. тонн</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Мощность на 1.01. года, следующего за отчетным, тыс. тонн</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Наличие основных фондов на 1.01. отчетного года, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>тыс. руб.</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="2">
									<span>
										<xsl:text>Изменение основных фондов за отчетный год, тыс. руб.</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Наличие основных фондов на 1.01. года, следующего за отчетным, тыс. руб.</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Незавершенное строительство на 1.01. отчетного года тыс. руб. </xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>Незавершенное строительство на 1.01. года, следующего за отчетным, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>тыс. руб. </xsl:text>
								...
								<th colspan="2">
									<span>
										<xsl:text>Прогноз по вводу мощностей по добыче на год, следующий за отчетным</xsl:text>
									</span>
								</th>
							</tr>
							<tr>
								<th>
									<span>
										<xsl:text>Ввод (увеличение)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>Выбытие (уменьшение)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>ввод</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>выбытие</xsl:text>
									</span>
								</th>
								<th>
									<span>
