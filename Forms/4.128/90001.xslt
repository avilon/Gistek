...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;90001&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="90001.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 1.73</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							...
							<tbody>
								<tr>
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Оперативные данные по несчастному случаю на производстве</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.128.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								...
								<tr style="height:0.81in; ">
									...
									<td style="text-align:center; " width="25%">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>не позднее 10 календарных дней с даты произошедшего несчастного случая и не позднее 10 дней с момента окончания расследования обстоятельств несчастного случая (для тяжелых несчастных случаев и несчастных случаев со смертельным исходом)</xsl:text>
										</span>
									</td>
									<td width="25%">
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>периодически</xsl:text>
											</span>
											<br/>
										</center>
									</td>
							...
							<tbody>
									...
									<td>
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strsubject[@id=121]">
								...
								<tr>
									...
									<td>
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strsubject[@id=125]">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
															<xsl:value-of select="string(.)"/>
														</span>
										...
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strsubject[@id=127]">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<tr>
									...
									<td>
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strsubject[@id=122]">
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
															<xsl:value-of select="string(.)"/>
														</span>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Информация по несчастному случаю на производстве.</xsl:text>
					</span>
					<br/>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>1. Дата и время несчастного случая:</xsl:text>
					</span>
					<br/>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
					...
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>, количество полных часов от начала работы - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>2.&#160;&#160; Организация&#160; (работодатель),&#160; работником&#160; которой&#160; является&#160; (являлся) пострадавший:</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Отраслевая принадлежность&#160;&#160; (основной&#160;&#160; вид&#160;&#160; деятельности&#160;&#160; организации&#160;&#160; по&#160; ОКВЭД) - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Наименование&#160;&#160; вышестоящего&#160;&#160; федерального&#160; органа&#160; исполнительной&#160; власти - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>ФИО работодателя - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>3. Сведения о пострадавшем (пострадавших):</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Профессиональный статус</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Профессия (должность)</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Стаж&#160; работы,&#160; при&#160; выполнении&#160; которой произошел несчастный случай</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>в том числе в данной организации</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Наличие детей (иждивенцев)</xsl:text>
										</span>
									</th>
								</tr>
							</thead>
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata3[@name ne &quot;&quot; and @id ne 3]">
											<tr>
												<td width="20%">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Сведения об организации, направившего работника</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Наименование структурного подразделения организации, работником которой является (являлся) пострадавший</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Наименование организации, направившей работника</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>ОКВЭД&#160; организации, направившей работника</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Место нахождения (фактический адрес) организации (работодателя)</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Юридический адрес организации (работодателя)</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Место нахождения (фактический адрес) организации</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>4.&#160; Сведения о проведении инструктажей и обучения по охране труда, проверке знаний по охране труда по профессии или виду работы, при выполнении которой произошел&#160; несчастный&#160; случай, если несчастный случай связан с недостатками обучения, проверки знаний и инструктирования.</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Дата последнего прохождения обучения по ТБ и ОТ</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Дата последней проверки знаний по ТБ и ОТ</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Результат последней проверки знаний по ТБ и ОТ</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Дата последнего инструктажа по ТБ и ОТ</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Вид последнего инструктажа по ТБ и ОТ</xsl:text>
										</span>
									</th>
								</tr>
							</thead>
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>5. Краткая характеристика места (объекта), где произошел несчастный случай: </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Наименование оборудования, использование которого привело к несчастному случаю</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Наименование оборудования</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Тип (марка) оборудования</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Год выпуска оборудования</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Завод-изготовитель оборудования</xsl:text>
										</span>
									</th>
								</tr>
							</thead>
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata2[@name ne &quot;&quot; and @id ne 2]">
											<tr>
												<td>
													<xsl:for-each select="@name">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>6. Обстоятельства несчастного случая:</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Краткое описание места происшествия - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Обстоятельства несчастного случая - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Вид происшествия - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Характер&#160; полученных&#160; повреждений:</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Характер полученных повреждений и орган, подвергшийся повреждению, медицинское заключение о тяжести повреждения здоровья</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Нахождение пострадавшего в состоянии алкогольного опьянения</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Последствия несчастного случая, число дней нетрудоспособности</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Последствия несчастного случая, категория инвалидности</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Последствия несчастного случая, смертельный исход</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Степень вины пострадавшего, %</xsl:text>
										</span>
									</th>
								</tr>
							</thead>
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>7. Причины несчастного случая:</xsl:text>
					</span>
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Причины несчастного случая - </xsl:text>
					</span>
					<xsl:for-each select="document">
						<xsl:for-each select="flat">
							<xsl:for-each select="strdata1">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>8. Лица, допустившие нарушение требований охраны труда:</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr style="height:0.18in; ">
									...
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Должность&#160; (профессия)</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Требования актов, предусматривающих ответственность за нарушения, явившиеся причинами несчастного случая</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Степень вины лица, допустившие нарушение требований охраны труда, %</xsl:text>
										</span>
									</th>
								</tr>
							</thead>
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata4[@name ne &quot;&quot; and @id ne 4]">
											<tr>
												<td width="20%">
													<xsl:for-each select="@name">
														<span style="font-family:Times New Roman; font-size:12pt; ">
					...
					<br/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>9. Мероприятия по устранению причин несчастного случая:</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1" width="100%">
							...
							<thead align="center" valign="middle">
								<tr>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Содержание мероприятий</xsl:text>
										</span>
									</th>
									<th style="text-align:center; ">
										<span style="font-family:Times New Roman; font-size:12pt; ">
											<xsl:text>Срок выполнения</xsl:text>
										</span>
									</th>
								</tr>
							</thead>
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata5[@col1 ne &quot;&quot; and @col2 ne &quot;&quot;]">
											<tr>
												<td>
													<xsl:for-each select="@col1">
														<span style="font-family:Times New Roman; font-size:12pt; ">
