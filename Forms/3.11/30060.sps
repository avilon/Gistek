...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="C:\SourceCode\Reports\GISTEK\XML\2015_07\1.15\20010_rpt.xsd" workingxmlfile="C:\SourceCode\Reports\GISTEK\XML\2015_07\1.15\20010_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о добыче нефти и газового конденсата по субъектам Российской Федерации">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Сведения о добыче по субъектам Российской Федерации"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Добыча за месяц"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Добыча с начала года"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
