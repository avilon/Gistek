...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="70126.xsd" workingxmlfile="70126.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Отчет о реализации мероприятий, основной целью которых является энергосбережение и (или) повышение энергетической эффективности организаций, осуществляющих регулируемые виды деятельностирегулируемые виды деятельности">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<line/>
					<text fixtext="Раздел  1 Сведения о реализации мероприятий, основной целью которых является энергосбережение и (или) повышение энергетической эффективности организаций, осуществляющих регулируемые виды деятельностирегулируемые виды деятельности"/>
					<newline/>
					<newline/>
					<tgrid>
						<properties border="1"/>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Наименование мероприятия программы"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Объемы выполнения				"/>
													<newline/>
												</children>
											</tgridcell>
											...
											<tgridcell>
												<children>
													<text fixtext="Численные значения экономии											"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											...
											<tgridcell>
												<children>
													<text fixtext="Затраты (план), млн. руб. (без НДС)			"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="всего накопительным итогом за годы реализации программы"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="в отчетном году"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="численное значение экономии в указанной размерности"/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="численное значение экономии, т у. т."/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="численное значение экономии, млн. руб."/>
													<newline/>
												</children>
											</tgridcell>
											<tgridcell>
																...
																<children>
																	<tgridrow>
																		<children>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="vol_paln_all">
																						<children>
																							<content subtype="regular">
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="vol_plan_year">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="vol_fact_all">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="vol_fact_year">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="cost_all_plan">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="cost_year_plan">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="cost_all_fact">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
																			...
																			<tgridcell>
																				<children>
																					<template subtype="attribute" match="cost_year_fact">
																						<children>
																							<content subtype="regular">
																								<format basic-type="xsd" datatype="decimal"/>
																							</content>
