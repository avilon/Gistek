...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;70126&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="70126.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Отчет о реализации мероприятий, основной целью которых является энергосбережение и (или) повышение энергетической эффективности организаций, осуществляющих регулируемые виды деятельностирегулируемые виды деятельности</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					<xsl:text>Раздел  1 Сведения о реализации мероприятий, основной целью которых является энергосбережение и (или) повышение энергетической эффективности организаций, осуществляющих регулируемые виды деятельностирегулируемые виды деятельности</xsl:text>
				</span>
				<br/>
				<br/>
					...
					<table border="1">
						...
						<thead>
							<tr>
								...
								<th colspan="5">
									<span>
										<xsl:text>Объемы выполнения				</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="14">
									<span>
										<xsl:text>Численные значения экономии											</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="4" rowspan="2">
									<span>
										<xsl:text>Затраты (план), млн. руб. (без НДС)			</xsl:text>
									</span>
									<br/>
								</th>
							</tr>
							...
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>всего накопительным итогом за годы реализации программы</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>в отчетном году</xsl:text>
									</span>
									<br/>
								</th>
								<th rowspan="2">
							...
							<tr>
								<th>
									<span>
										<xsl:text>численное значение экономии в указанной размерности</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>численное значение экономии, т у. т.</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									<span>
										<xsl:text>численное значение экономии, млн. руб.</xsl:text>
									</span>
									<br/>
								</th>
								<th>
									...
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata">
											<tr>
												...
												<td>
													<xsl:for-each select="@vol_paln_all">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_plan_year">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_fact_all">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@vol_fact_year">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_plan">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_all_fact">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
												...
												<td>
													<xsl:for-each select="@cost_year_fact">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
													</xsl:for-each>
