...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;30016&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="30016_rpt.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о среднесписочной численности персонала и фонде заработной платы</xsl:text>
				</span>
				<br/>
				<span style="font-size:16pt; ">
				...
				<br/>
				<span>
					<xsl:text>Раздел 1. Сведения о среднесписочной численности персонала и фонде заработной платы</xsl:text>
				</span>
				<br/>
						...
						<tbody>
							<tr>
								...
								<td colspan="2" style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>Среднесписочная численность, всего персонала, (человек)</xsl:text>
									</span>
								</td>
								<td colspan="2" style="text-align:center; ">
									<span style="font-weight:bold; ">
							...
							<tr>
								<td style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>факт с начала отчетного года</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span style="font-weight:bold; ">
										<xsl:text>Соответствующий период прошлого года</xsl:text>
									</span>
								</td>
								<td style="text-align:center; ">
									<span style="font-weight:bold; ">
							...
							<tr>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=41]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=22]">
													<xsl:for-each select="@name">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=32]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=42]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=23]">
													<xsl:for-each select="@name">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=33]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=43]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=24]">
													<xsl:for-each select="@name">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=34]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=44]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
							...
							<tr>
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=25]">
													<xsl:for-each select="@name">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=35]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
								...
								<td>
									<xsl:for-each select="$XML">
										<xsl:for-each select="document">
											<xsl:for-each select="flat">
												<xsl:for-each select="strdata[@code=45]">
													<xsl:for-each select="@column1">
														<span>
															<xsl:value-of select="string(.)"/>
														</span>
