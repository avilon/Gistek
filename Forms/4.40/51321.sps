...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="51321.xsd" workingxmlfile="51321.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о работе гидроэлектростанций и (или) иных генерирующих объектов, функционирующих на основе использования возобновляемых источников энергии за год">
						<styles font-size="16pt"/>
					</text>
					<newline/>
					<newline/>
					<line/>
					<text fixtext="Раздел 1. Общие сведения"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Значение показателя"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
