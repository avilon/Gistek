...
<structure version="17" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces/>
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="1045_rpt.xsd" workingxmlfile="1045_rpt.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<text fixtext="Сведения о завозе угля в районы Крайнего Севера и приравненные к ним местности с ограниченными сроками завоза">
					...
					<newline/>
					<newline/>
					<text fixtext="Раздел 1. Сведения о поставках угля"/>
					<newline/>
					<tgrid>
						<properties border="1"/>
						<children>
								...
								<children>
									<tgridrow>
										<children>
											<tgridcell>
												<children>
													<text fixtext="Направление поставки"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Заключено договоров на поставку угля с начала отчетного года"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
											<tgridcell>
												<children>
													<text fixtext="Фактически поставлено с начала отчетного года"/>
												</children>
											</tgridcell>
											<tgridcell joinleft="1"/>
										</children>
									...
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="в т.ч. по районам с ограниченными сроками завоза грузов"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Значене1"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
													<text fixtext="Значение2"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
								...
								<children>
									<tgridrow>
										<children>
											...
											<tgridcell>
												<children>
													<text fixtext="Котактный телефон (с кодом города)"/>
												</children>
											</tgridcell>
											<tgridcell>
												<children>
