...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;20055&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="20055_rpt.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
		...
		<html>
			...
			<body>
				<span style="font-size:16pt; ">
					<xsl:text>Сведения о балансе производственных мощностей</xsl:text>
				</span>
				<br/>
				<hr/>
				<span>
					...
					<table border="1">
						...
						<thead>
							<tr>
								<th rowspan="4">
									<span>
										<xsl:text>Вид установки</xsl:text>
									</span>
								</th>
								<th rowspan="4">
									<span>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Мощность на начало отчетного года, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>т/год</xsl:text>
									</span>
									<br/>
								</th>
								<th colspan="12">
									<span>
										<xsl:text>Изменение производственной мощности в отчетном году, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>т/год</xsl:text>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Мощность на начало года, следующего за отчетным, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>т/год</xsl:text>
								...
								<th rowspan="3">
									<span>
										<xsl:text>Количество переработанного сырья в отчетном году, </xsl:text>
									</span>
									<br/>
									<span>
										<xsl:text>т</xsl:text>
							...
							<tr>
								<th rowspan="2">
									<span>
										<xsl:text>увеличение мощности - </xsl:text>
									</span>
									<br/>
									<span>
								...
								<th colspan="6">
									<span>
										<xsl:text>в том числе за счет:</xsl:text>
									</span>
								</th>
								<th rowspan="2">
									<span>
										<xsl:text>уменьшение мощности - всего</xsl:text>
									</span>
								</th>
								<th colspan="4">
									<span>
							...
							<tr>
								<th>
									<span>
										<xsl:text>ввода в действие новых и расширения действующих предприятий</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>реконструкции действующих предприятий</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>технического перевооружения действующих предприятий и проведения организационно-технических мероприятий</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>оборудования, взятого в аренду</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>изменения номенклатуры продукции (уменьшения трудоемкости)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>прочих факторов</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>изменения номенклатуры продукции (увеличения трудоемкости)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>выбытия (ветхости, исчерпания запасов)</xsl:text>
									</span>
								</th>
								<th>
									<span>
										<xsl:text>оборудования, сданного в аренду</xsl:text>
									</span>
								</th>
								<th>
									<span>
