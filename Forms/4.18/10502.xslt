...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;10502&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="10502.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
				...
				<xsl:for-each select="$XML">
					<pre style="text-align:right; ">
						<span style="font-family:Times New Roman; padding-left:inherit; ">
							<xsl:text>Приложение № 4.18.1</xsl:text>
						</span>
						<br/>
						<span style="font-family:Times New Roman; padding-left:inherit; ">
								...
								<tr>
									<td style="text-align:center; ">
										<center style="text-align:center; ">
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>Предложения о демонтаже генерирующего оборудования электростанций</xsl:text>
											</span>
										</center>
										<center style="text-align:center; ">
											<span style="font-family:Times New Roman; font-size:12pt; font-weight:bold; ">
												<xsl:text>за_____________________________годы</xsl:text>
											</span>
										</center>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										<center>
											<span style="font-family:Times New Roman; font-size:12pt; ">
												<xsl:text>Шифр формы: 4.18.</xsl:text>
											</span>
										</center>
									</td>
								</tr>
					...
					<center/>
					<span style="font-family:Times New Roman; font-size:12pt; ">
						<xsl:text>Раздел 1. Предложения по демонтажу генерирующего оборудования на действующих электростанциях (на прогнозный период 15 лет)</xsl:text>
					</span>
					<br/>
					<xsl:variable name="altova:table">
						<table border="1">
								...
								<tr>
									<th rowspan="2">
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Наименование электростанции</xsl:text>
										</span>
									</th>
									<th rowspan="2">
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Наименование энергоагрегата</xsl:text>
										</span>
									</th>
									<th rowspan="2" style="width:0.57in; ">
										<span style="font-family:Times New Roman; font-size:9pt; ">
									...
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Действие с оборудованием </xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Номер агрегата (станционный номер)</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Вид основного топлива выводимого агрегата</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Вид резервного топлива выводимого агрегата</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Установленная электрическая мощность выводимого агрегата, МВт</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Установленная тепловая мощность выводимого агрегата, Гкал/ч</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
									...
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Ожидаемый месяц и год вывода из эксплуатации</xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Участие в нормативном первичном и автоматическом вторичном регулировании частоты и перетоков мощности</xsl:text>
										</span>
										<br/>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>(да/нет)</xsl:text>
										</span>
										<br/>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
											<xsl:text>Ожидаемые затраты на окончательный демонтаж, тыс. руб. </xsl:text>
										</span>
									</th>
									<th>
										<span style="font-family:Times New Roman; font-size:9pt; ">
							...
							<tbody>
								<xsl:for-each select="document">
									<xsl:for-each select="flat">
										<xsl:for-each select="strdata[@col10 ne &quot;&quot; and @col11 ne &quot;&quot; and @col12 ne &quot;&quot; and @col13 ne &quot;&quot;]">
											<tr>
												<td>
													<xsl:for-each select="@col2">
												...
												<td style="text-align:center; width:0.57in; ">
